import{_ as r,r as a,o,c,b as e,e as i,w as t,d as n,a as d}from"./app-HzbtDe0_.js";const h={},u=e("h1",{id:"排序",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#排序","aria-hidden":"true"},"#"),n(" 排序")],-1),m=d(`<ol><li><p>冒泡排序</p></li><li><p>选择排序：选择排序与冒泡排序有点像，只不过选择排序每次都是在确定了最小数的下标之后再进行交换，大大减少了交换的次数</p></li><li><p>插入排序：将一个记录插入到已排序的有序表中，从而得到一个新的，记录数增1的有序表</p></li><li><p>快速排序：通过一趟排序将序列分成左右两部分，其中左半部分的的值均比右半部分的值小，然后再分别对左右部分的记录进行排序，直到整个序列有序。</p><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>int partition(int a[],  int low, int high){
    int key = a[low];
    while( low &lt; high ){
