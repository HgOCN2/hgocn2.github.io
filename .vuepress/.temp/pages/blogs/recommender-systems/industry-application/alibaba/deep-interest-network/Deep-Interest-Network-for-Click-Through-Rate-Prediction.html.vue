...
<p><img src="@source/blogs/recommender-systems/industry-application/alibaba/deep-interest-network/pic/DIN-paper.png" alt="DIN-paper"></p>
...
<p>不明白？举个例子：</p>
<p><img src="@source/blogs/recommender-systems/industry-application/alibaba/deep-interest-network/pic/DIN-user-behavior.jpg" alt="DIN-user-behavior"></p>
...
<p><img src="@source/blogs/recommender-systems/industry-application/alibaba/deep-interest-network/pic/DIN-system.png" alt="DIN-system"></p>
...
<p><img src="@source/blogs/recommender-systems/industry-application/alibaba/deep-interest-network/pic/DIN-feature.png" alt="DIN-feature"></p>
...
<p><img src="@source/blogs/recommender-systems/industry-application/alibaba/deep-interest-network/pic/DIN-base-model.png" alt="DIN-base-model"></p>
...
<p>这个图太重要了，一定要仔细研究：</p>
<p><img src="@source/blogs/recommender-systems/industry-application/alibaba/deep-interest-network/pic/DIN-model.png" alt="DIN-model"></p>
<p>先给出结论：</p>
<ol>
...
<p><img src="@source/blogs/recommender-systems/industry-application/alibaba/deep-interest-network/pic/DIN-ps.png" alt="DIN-ps"></p>
<p>p(s)的计算分为两步：</p>
<ol>
...
<p><img src="@source/blogs/recommender-systems/industry-application/alibaba/deep-interest-network/pic/DIN-XDL-platform.jpg" alt="DIN-XDL-platform"></p>
...
<p><img src="@source/blogs/recommender-systems/industry-application/alibaba/deep-interest-network/pic/DIN-common-feature.jpg" alt="DIN-common-feature"></p>
...
<p><img src="@source/blogs/recommender-systems/industry-application/alibaba/deep-interest-network/pic/DIN-visualize.png" alt="DIN-visualize"></p>
<p>利用候选的广告，反向激活历史兴趣。不同的历史兴趣爱好对于当前候选广告的权重不同，做到了local activation，如下图：</p>
<p><img src="@source/blogs/recommender-systems/industry-application/alibaba/deep-interest-network/pic/DIN-history-weight.png" alt="DIN-history-weight"></p>
