...
<p><img src="@source/blogs/recommender-systems/industry-application/alibaba/deep-session-interest-network/pic/DSIN-paper.png" alt="DSIN-paper"></p>
...
<p><img src="@source/blogs/recommender-systems/industry-application/alibaba/deep-session-interest-network/pic/session-demo.png" alt="session-demo"></p>
...
<p>损失函数：</p>
<p><img src="@source/blogs/recommender-systems/industry-application/alibaba/deep-session-interest-network/pic/loss-function.png" alt="loss-function"></p>
<h2 id="dsin模型" tabindex="-1"><a class="header-anchor" href="#dsin模型" aria-hidden="true">#</a> DSIN模型</h2>
<p><img src="@source/blogs/recommender-systems/industry-application/alibaba/deep-session-interest-network/pic/DSIN-model.png" alt="DSIN-model"></p>
<p>其中，激活单元具体结构和右下角方框中的各层的名称为</p>
<p><img src="@source/blogs/recommender-systems/industry-application/alibaba/deep-session-interest-network/pic/DSIN-model-1.png" alt="DSIN-model-1"></p>
...
<p><img src="@source/blogs/recommender-systems/industry-application/alibaba/deep-session-interest-network/pic/session-division-layer.png" alt="session-division-layer"></p>
...
<p><img src="@source/blogs/recommender-systems/industry-application/alibaba/deep-session-interest-network/pic/session-interest-extractor-layer.png" alt="session-interest-extractor-layer"></p>
...
<p><img src="@source/blogs/recommender-systems/industry-application/alibaba/deep-session-interest-network/pic/transformer.png" alt="transformer"></p>
...
<p><img src="@source/blogs/recommender-systems/industry-application/alibaba/deep-session-interest-network/pic/session-interest-interacting-layer.png" alt="session-interest-interacting-layer"></p>
<p>用户的会话兴趣，是有序列关系在里面的，这种关系，我们通过一个双向LSTM(bi-LSTM)来处理：</p>
<p><img src="@source/blogs/recommender-systems/industry-application/alibaba/deep-session-interest-network/pic/Bi-LSTM.png" alt="Bi-LSTM"></p>
<p>每个时刻的hidden state计算：</p>
<p><img src="@source/blogs/recommender-systems/industry-application/alibaba/deep-session-interest-network/pic/Bi-LSTM-hidden.png" alt="Bi-LSTM-hidden"></p>
...
<p>评价指标是AUC。结果如图：</p>
<p><img src="@source/blogs/recommender-systems/industry-application/alibaba/deep-session-interest-network/pic/datasets-metric.png" alt="datasets-metric"></p>
<p>其中，</p>
...
<p><img src="@source/blogs/recommender-systems/industry-application/alibaba/deep-session-interest-network/pic/visualize-attention-weights.png" alt="visualize-attention-weights"></p>
