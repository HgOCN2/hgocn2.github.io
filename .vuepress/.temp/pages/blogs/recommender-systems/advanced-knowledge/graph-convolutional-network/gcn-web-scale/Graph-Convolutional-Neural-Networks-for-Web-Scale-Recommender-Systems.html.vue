...
<ul>
<li><RouterLink to="/blogs/recommender-systems/advanced-knowledge/graph-convolutional-network/advanced-knowledge.html">返回上层目录</RouterLink></li>
...
<p><img src="@source/blogs/recommender-systems/advanced-knowledge/graph-convolutional-network/gcn-web-scale/pic/gcn-ws-rs-paper-title.png" alt="gcn-ws-rs-paper-title"></p>
<blockquote>
...
<p><img src="@source/blogs/recommender-systems/advanced-knowledge/graph-convolutional-network/gcn-web-scale/pic/Pinterest.png" alt="Pinterest"></p>
...
<p>下图是论文提出来的卷积模型结构</p>
<p><img src="@source/blogs/recommender-systems/advanced-knowledge/graph-convolutional-network/gcn-web-scale/pic/gcn-ws-rs-paper-model.png" alt="gcn-ws-rs-paper-model"></p>
<p>整个算法中，局部卷积算法'CONVOLVE'应该是最核心的部分。</p>
<p><img src="@source/blogs/recommender-systems/advanced-knowledge/graph-convolutional-network/gcn-web-scale/pic/gcn-ws-rs-paper-local-conv.png" alt="gcn-ws-rs-paper-local-conv"></p>
...
<p><img src="@source/blogs/recommender-systems/advanced-knowledge/graph-convolutional-network/gcn-web-scale/pic/gcn-ws-rs-paper-local-conv-desc.png" alt="gcn-ws-rs-paper-local-conv-desc"></p>
...
<p><img src="@source/blogs/recommender-systems/advanced-knowledge/graph-convolutional-network/gcn-web-scale/pic/gcn-ws-rs-paper-model-tranning.png" alt="gcn-ws-rs-paper-model-tranning"></p>
