...
<p><img src="@source/blogs/machine-learning/ensemble-learning/boosting/gradient-boosting/xgboost/xgboost-practice/pic/xgboost-dmlc.jpg" alt="xgboost-dmlc"></p>
...
<p>具体公式如下：</p>
<p><img src="@source/blogs/machine-learning/ensemble-learning/boosting/gradient-boosting/xgboost/xgboost-practice/pic/leaf-w.jpeg" alt="leaf-w"></p>
...
<p>特征重要性：</p>
<p><img src="@source/blogs/machine-learning/ensemble-learning/boosting/gradient-boosting/xgboost/xgboost-practice/pic/feature-importance-1.png" alt="feature-importance-1"></p>
<p>第1棵树的图：</p>
<p><img src="@source/blogs/machine-learning/ensemble-learning/boosting/gradient-boosting/xgboost/xgboost-practice/pic/tree-pic-1.png" alt="tree-pic-1.png"></p>
...
<p><img src="@source/blogs/machine-learning/ensemble-learning/boosting/gradient-boosting/xgboost/xgboost-practice/pic/data-pic-2.png" alt="data-pic-2"></p>
...
<p><img src="@source/blogs/machine-learning/ensemble-learning/boosting/gradient-boosting/xgboost/xgboost-practice/pic/result-2.png" alt="result-2"></p>
<p>特征重要性：</p>
<p><img src="@source/blogs/machine-learning/ensemble-learning/boosting/gradient-boosting/xgboost/xgboost-practice/pic/feature-importance-2.png" alt="feature-importance-2"></p>
<p>第一棵树的图：</p>
<p><img src="@source/blogs/machine-learning/ensemble-learning/boosting/gradient-boosting/xgboost/xgboost-practice/pic/tree-pic-2.png" alt="tree-pic-2"></p>
...
<p>特征重要性：</p>
<p><img src="@source/blogs/machine-learning/ensemble-learning/boosting/gradient-boosting/xgboost/xgboost-practice/pic/feature-importance-3.png" alt="feature-importance-3"></p>
<p>第1棵树的图：</p>
<p><img src="@source/blogs/machine-learning/ensemble-learning/boosting/gradient-boosting/xgboost/xgboost-practice/pic/tree-pic-3.png" alt="tree-pic-3"></p>
...
<p>回归的例子没找到，我就造了一个逻辑回归的，但其实还是二分类，但实际应用中，二分类用的比较多，那就用这个例子吧。当然你可以自己造一个回归的例子。</p>
<p><img src="@source/blogs/machine-learning/ensemble-learning/boosting/gradient-boosting/xgboost/xgboost-practice/pic/data-pic-4.png" alt="data-pic-4"></p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token comment"># -*- coding=utf-8 -*-</span>
<span class="token keyword">import</span> numpy <span class="token keyword">as</span> np
<span class="token keyword">import</span> matplotlib<span class="token punctuation">.</span>pyplot <span class="token keyword">as</span> plt
<span class="token keyword">import</span> xgboost <span class="token keyword">as</span> xgb
...
<p><img src="@source/blogs/machine-learning/ensemble-learning/boosting/gradient-boosting/xgboost/xgboost-practice/pic/result-4.png" alt="result-4"></p>
<p>特征重要性：</p>
<p><img src="@source/blogs/machine-learning/ensemble-learning/boosting/gradient-boosting/xgboost/xgboost-practice/pic/feature-importance-4.png" alt="feature-importance-4"></p>
<p>第一棵树的图：</p>
<p><img src="@source/blogs/machine-learning/ensemble-learning/boosting/gradient-boosting/xgboost/xgboost-practice/pic/tree-pic-4.png" alt="tree-pic-4"></p>
