...
<ul>
<li><RouterLink to="/blogs/model-deployment/model-deployment/model-deployment.html">返回上层目录</RouterLink></li>
...
<p><img src="@source/blogs/model-deployment/model-deployment/tensorflow-cpp-deployment/pic/tensorflow-c-lib.png" alt="tensorflow-c-lib"></p>
...
<p><img src="@source/blogs/model-deployment/model-deployment/tensorflow-cpp-deployment/pic/libtensorflow-1.12-download.png" alt="libtensorflow-1.12-download"></p>
<p>注：最新版(2.10.0版)的下载下来，头文件有好几个，doing链接库也分为了dll和配套的lib。</p>
<p><img src="@source/blogs/model-deployment/model-deployment/tensorflow-cpp-deployment/pic/libtensorflow-2.10-download.png" alt="libtensorflow-2.10-download"></p>
...
<p><img src="@source/blogs/model-deployment/model-deployment/tensorflow-cpp-deployment/pic/tensorFlow-c++-api-reference.png" alt="tensorFlow-c++-api-reference"></p>
...
<p><img src="@source/blogs/model-deployment/model-deployment/tensorflow-cpp-deployment/pic/github-neargye.png" alt="github-neargye"></p>
...
<p><img src="@source/blogs/model-deployment/model-deployment/tensorflow-cpp-deployment/pic/cmake-create-vs2017.png" alt="cmake-create-vs2017"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/blogs/model-deployment/model-deployment/tensorflow-cpp-deployment/pic/cmake-build-vs2017.png" alt="cmake-build-vs2017"></p>
...
<p><img src="@source/blogs/model-deployment/model-deployment/tensorflow-cpp-deployment/pic/github-vs-sln.png" alt="github-vs-sln"></p>
...
<p><img src="@source/blogs/model-deployment/model-deployment/tensorflow-cpp-deployment/pic/vs-file-structure.png" alt="vs-file-structure"></p>
<p>然后把原代码中的<code v-pre>graph_info</code>工程中的代码加进来，目的是为了显示pb模型文件的结构，方便找出输入和输出的变量名。</p>
<p><img src="@source/blogs/model-deployment/model-deployment/tensorflow-cpp-deployment/pic/vs-file-structure-2.png" alt="vs-file-structure-2"></p>
...
<p><img src="@source/blogs/model-deployment/model-deployment/tensorflow-cpp-deployment/pic/vs-lib-load.png" alt="vs-lib-load"></p>
<ul>
<li>然后添加工程引用的lib<strong>文件名</strong>：工程-&gt;属性-&gt;配置属性-&gt;链接器-&gt;输入-&gt;附加依赖项：加上lib文件名。</li>
</ul>
<p><img src="@source/blogs/model-deployment/model-deployment/tensorflow-cpp-deployment/pic/vs-lib-load-2.png" alt="vs-lib-load-2"></p>
...
<p><img src="@source/blogs/model-deployment/model-deployment/tensorflow-cpp-deployment/pic/vs-h-load.png" alt="vs-h-load"></p>
<p><strong>第三步：VS工程模式选择</strong></p>
<p>最后要注意，VS工程选择的是32位还是64位，是Debug模式还是Release模式。选择不同，可能会导致动态链接库链接失败。</p>
<p><img src="@source/blogs/model-deployment/model-deployment/tensorflow-cpp-deployment/pic/vs-load.png" alt="vs-load"></p>
...
<p><img src="@source/blogs/model-deployment/model-deployment/tensorflow-cpp-deployment/pic/cppflow.png" alt="cppflow"></p>
<h2 id="查看并梳理cppflow工程代码" tabindex="-1"><a class="header-anchor" href="#查看并梳理cppflow工程代码" aria-hidden="true">#</a> 查看并梳理CppFlow工程代码</h2>
<p><img src="@source/blogs/model-deployment/model-deployment/tensorflow-cpp-deployment/pic/cppflow-github.png" alt="cppflow-github"></p>
...
<p><img src="@source/blogs/model-deployment/model-deployment/tensorflow-cpp-deployment/pic/cppflow-diy-include.png" alt="cppflow-diy-include"></p>
