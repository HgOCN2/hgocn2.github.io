...
<ul>
<li><RouterLink to="/blogs/mathematics/linear-algebra/linear-algebra.html">返回上层目录</RouterLink></li>
...
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/lena.jpg" alt="lena"><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/lena-whole.jpg" alt="lena-whole"></p>
...
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/Ueno-Juri.jpg" alt="Ueno-Juri"></p>
...
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/Ueno-Juri-A1.jpg" alt="Ueno-Juri-A1"></p>
<p>结果就是完全看不清是啥……我们试着多增加几项进来：
$$
A_5=\sigma_1 u_1 v_1^{T}+\sigma_2 u_2 v_2^{T}+\sigma_3 u_3 v_3^{T}+\sigma_4 u_4 v_4^{T}+\sigma_5 u_5 v_5^T
$$
，再作图</p>
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/Ueno-Juri-A5.jpg" alt="Ueno-Juri-A5"></p>
<p>隐约可以辨别这是短发伽椰子的脸……但还是很模糊，毕竟我们只取了5个奇异值而已。下面我们取20个奇异值试试，也就是(1)式等式右边取前20项构成A20</p>
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/Ueno-Juri-A20.jpg" alt="Ueno-Juri-A20"></p>
<p>虽然还有些马赛克般的模糊，但我们总算能辨别出这是Juri酱的脸。当我们取到(1)式等式右边前50项时：</p>
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/Ueno-Juri-A50.jpg" alt="Ueno-Juri-A50"></p>
...
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/pic-with-noise-0.jpg" alt="pic-with-noise-0"></p>
<p>但往往我们只能得到如下带有噪声的图像（和无噪声图像相比，下图的部分白格子中带有灰色）：</p>
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/pic-with-noise-1.jpg" alt="pic-with-noise-1"></p>
<p>通过奇异值分解，我们发现矩阵的奇异值从大到小分别为：14.15，4.67，3.00，0.21，……，0.05。除了前3个奇异值较大以外，其余奇异值相比之下都很小。强行令这些小奇异值为0，然后只用前3个奇异值构造新的矩阵，得到</p>
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/pic-with-noise-2.jpg" alt="pic-with-noise-2"></p>
...
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/matrix-1.jpg" alt="matrix-1">$M \rightarrow$<img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/matrix-2.jpg" alt="matrix-2"></p>
<p>如果$M$不是对角矩阵，而是一个<strong>对称矩阵</strong>
$$
M = \begin{bmatrix}2 &amp; 1\1 &amp; 2\end{bmatrix}
$$
对于对称矩阵，<strong>我们也总可以找到一组网格线，使得矩阵作用在该网格上仅仅表现为（反射）拉伸变换，而没有旋转变换。</strong></p>
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/matrix-3.gif" alt="matrix-3">$M  \rightarrow$<img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/matrix-4.gif" alt="matrix-4"></p>
<p>上图并不能清晰地描述对称矩阵的变换效果，于是我们将网格线旋转45°，看看会发生什么。</p>
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/matrix-5.jpg" alt="matrix-5">$M \rightarrow$<img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/matrix-6.jpg" alt="matrix-6"></p>
...
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/matrix-7.gif" alt="matrix-7">$M \rightarrow$<img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/matrix-8.gif" alt="matrix-8"></p>
<p>很容易找到一族沿着水平轴的特征向量。然而，上面的图像显示这些特征值不能创造一个正交网格，能够被变换为另一个正交网格。尽管如此，我们还是来看下如果先把网格旋转30°会发生什么。</p>
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/matrix-9.gif" alt="matrix-9">$M \rightarrow$<img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/matrix-10.gif" alt="matrix-10"></p>
<p>注意，红色平行四边形的原点处的夹角似乎比之前的大了一些，那我们就有理由猜测，是不是继续旋转，夹角会越来越大，直到垂直呢？让我们继续把网格旋转到60°试试。</p>
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/matrix-11.gif" alt="matrix-11">$M \rightarrow$<img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/matrix-12.gif" alt="matrix-11"></p>
<p>嗯~似乎现在转换后的网格已经几乎垂直了。但实际上，当旋转角度精确为58.28°时，网格会正交。</p>
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/matrix-13.gif" alt="matrix-13">$M \rightarrow$<img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/matrix-14.gif" alt="matrix-14"></p>
...
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/matrix-21.gif" alt="matrix-21">$M \rightarrow$<img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/matrix-22.gif" alt="matrix-22"></p>
...
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/matrix-23.gif" alt="matrix-23"></p>
<p>因此我们有
$$
\begin{aligned}
M v_1 = \sigma_1 u_1\
...
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/matrix-31.gif" alt="matrix-31">$M \rightarrow$<img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/matrix-32.gif" alt="matrix-32"></p>
<p>注意，主轴和短轴被定义为$M v_1$和$M v_2$。这些向量因此是所有单位圆向量中最长和最短的向量。</p>
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/matrix-33.gif" alt="matrix-33">$M \rightarrow$<img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/matrix-34.gif" alt="matrix-34"></p>
...
$$
该矩阵的几何效果如下图所示：</p>
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/matrix-41.gif" alt="matrix-41">$M \rightarrow$<img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/matrix-42.gif" alt="matrix-42"></p>
...
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/data-compression-1.gif" alt="data-compression-1"></p>
<p>在这幅图中，存在着三种类型的列，如下图所示，这三中列应该能够以更复杂的形式来表示这些图像数据。</p>
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/data-compression-2.gif" alt="data-compression-2">          <img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/data-compression-3.gif" alt="data-compression-3">          <img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/data-compression-4.gif" alt="data-compression-4"></p>
<p>我们把这个图像用15×25矩阵表示，0代表黑色像素，1代表白色像素。这样的话，矩阵一共有375个元素。</p>
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/data-compression-5.gif" alt="data-compression-5"></p>
...
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/noise-reduction-1.gif" alt="noise-reduction-1"></p>
...
$$
这样就可以改善图像质量。</p>
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/noise-reduction-2.jpg" alt="noise-reduction-2"></p>
...
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/data-analysis-1.gif" alt="data-analysis-1"></p>
<p>我们把这些数据放到矩阵中：
$$
M=
\begin{bmatrix}
...
<p><img src="@source/blogs/mathematics/linear-algebra/singular-value-decomposition/pic/data-analysis-2.gif" alt="data-analysis-2"></p>
