...
<ul>
<li><RouterLink to="/blogs/natural-language-processing/word2vec/word2vec.html">返回上层目录</RouterLink></li>
</ul>
...
<p>对于以上的过程，可以由下图表示：</p>
<p><img src="@source/blogs/natural-language-processing/word2vec/word2vec-source-code-analysis/pic/word2vec-flow-chart.bmp" alt="word2vec-flow-chart"></p>
...
<p><img src="@source/blogs/natural-language-processing/word2vec/word2vec-source-code-analysis/pic/LearnVocabFromTrainFile-flow-chartbmp.bmp" alt="LearnVocabFromTrainFile-flow-chartbmp"></p>
...
<p><img src="@source/blogs/natural-language-processing/word2vec/word2vec-source-code-analysis/pic/init_net.bmp" alt="init_net"></p>
...
<p><img src="@source/blogs/natural-language-processing/word2vec/word2vec-source-code-analysis/pic/CreateBinaryTree-huffman-tree-construction.bmp" alt="CreateBinaryTree-huffman-tree-construction"></p>
...
<p><img src="@source/blogs/natural-language-processing/word2vec/word2vec-source-code-analysis/pic/CreateBinaryTree-huffman-tree-construction-1.png" alt="CreateBinaryTree-huffman-tree-construction-1"></p>
<p><img src="@source/blogs/natural-language-processing/word2vec/word2vec-source-code-analysis/pic/CreateBinaryTree-huffman-tree-construction-2.png" alt="CreateBinaryTree-huffman-tree-construction-2"></p>
<p><img src="@source/blogs/natural-language-processing/word2vec/word2vec-source-code-analysis/pic/CreateBinaryTree-huffman-tree-construction-3.png" alt="CreateBinaryTree-huffman-tree-construction-3"></p>
<p><img src="@source/blogs/natural-language-processing/word2vec/word2vec-source-code-analysis/pic/CreateBinaryTree-huffman-tree-construction-4.png" alt="CreateBinaryTree-huffman-tree-construction-4"></p>
<p><img src="@source/blogs/natural-language-processing/word2vec/word2vec-source-code-analysis/pic/CreateBinaryTree-huffman-tree-construction-5.png" alt="CreateBinaryTree-huffman-tree-construction-5"></p>
<p>构建好Huffman树后，此时，需要根据构建好的Huffman树生成对应节点的Huffman编码。假设，上述的数据生成的最终的Huffman树为：</p>
<p><img src="@source/blogs/natural-language-processing/word2vec/word2vec-source-code-analysis/pic/CreateBinaryTree-Huffman-tree-example.bmp" alt="CreateBinaryTree-Huffman-tree-example"></p>
<p>此时，count数组，binary数组和parent_node数组分别为：</p>
<p><img src="@source/blogs/natural-language-processing/word2vec/word2vec-source-code-analysis/pic/CreateBinaryTree-huffman-tree-count-binary-parent-node.bmp" alt="CreateBinaryTree-huffman-tree-count-binary-parent-node"></p>
