...
<p><img src="@source/blogs/machine-learning-framework/tensorflow/tools/ckpt-to-pb/pic/ckpt-model.png" alt="ckpt-model"></p>
<ul>
<li>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/blogs/machine-learning-framework/tensorflow/tools/ckpt-to-pb/pic/output-node.png" alt="output-node"></p>
