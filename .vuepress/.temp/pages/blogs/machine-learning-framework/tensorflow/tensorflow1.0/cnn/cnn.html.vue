...
<p><img src="@source/blogs/machine-learning-framework/tensorflow/tensorflow1.0/cnn/pic/alexnet-architecture.png" alt="alexnet-architecture"></p>
...
<p><img src="@source/blogs/machine-learning-framework/tensorflow/tensorflow1.0/cnn/pic/stanford-dogs-dataset.png" alt="stanford-dogs-dataset"></p>
<p>每个狗品种都对应一个类似于<code v-pre>n02085620-Chihuahua</code>的文件夹，其中目录名称的后一半对应于狗品种的英语表达。在每个目录中，都有大量属于该品种的狗的图像，每幅图都是JPEG格式且尺寸各异。</p>
<p><img src="@source/blogs/machine-learning-framework/tensorflow/tensorflow1.0/cnn/pic/stanford-dogs-dataset-chihuahua.png" alt="stanford-dogs-dataset-chihuahua"></p>
