...
<ul>
<li><RouterLink to="/blogs/reinforcement-learning/reinforcement-learning/state-reward-action/state-reward-action.html">返回上层目录</RouterLink></li>
...
<p><img src="@source/blogs/reinforcement-learning/reinforcement-learning/state-reward-action/reward/pic/two-equal.png" alt="two-equal"></p>
<p>要理解上图为什么是等价的，需要</p>
<ul>
