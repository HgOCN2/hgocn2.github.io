...
<p><img src="@source/blogs/deep-learning/recurrent-neural-network/recurrent-neural-network/pic/slot-filling.jpg" alt="slot-filling"></p>
...
<p><img src="@source/blogs/deep-learning/recurrent-neural-network/recurrent-neural-network/pic/book-tiket.jpg" alt="book-tiket"></p>
...
<p><img src="@source/blogs/deep-learning/recurrent-neural-network/recurrent-neural-network/pic/rnn.jpg" alt="rnn.jpg"></p>
...
<p><img src="@source/blogs/deep-learning/recurrent-neural-network/recurrent-neural-network/pic/rnn-example1.jpg" alt="rnn-example1.jpg"></p>
<p>然后如下图所示<strong>隐藏层的值2被写到memory中</strong>，接下来再输入第二个单词的embedding，那么<strong>隐藏层的输入有四个</strong>，加权的结果是6，输出的结果也是6。</p>
<p><img src="@source/blogs/deep-learning/recurrent-neural-network/recurrent-neural-network/pic/rnn-example2.jpg" alt="rnn-example2"></p>
...
<p><img src="@source/blogs/deep-learning/recurrent-neural-network/recurrent-neural-network/pic/rnn-example3.jpg" alt="rnn-example3"></p>
...
<p><img src="@source/blogs/deep-learning/recurrent-neural-network/recurrent-neural-network/pic/rnn-example4.jpg" alt="rnn-example4"></p>
...
<p><img src="@source/blogs/deep-learning/recurrent-neural-network/recurrent-neural-network/pic/rnn-example5.jpg" alt="rnn-example5"></p>
<h2 id="公式" tabindex="-1"><a class="header-anchor" href="#公式" aria-hidden="true">#</a> 公式</h2>
<p><img src="@source/blogs/deep-learning/recurrent-neural-network/recurrent-neural-network/pic/rnn-structure4.jpg" alt="rnn-structure4"></p>
...
<p><img src="@source/blogs/deep-learning/recurrent-neural-network/recurrent-neural-network/pic/rnn-structure1.jpg" alt="rnn-structure"></p>
...
<p><img src="@source/blogs/deep-learning/recurrent-neural-network/recurrent-neural-network/pic/rnn-structure2.jpg" alt="rnn-structure2"></p>
...
<p><img src="@source/blogs/deep-learning/recurrent-neural-network/recurrent-neural-network/pic/rnn-structure3.jpg" alt="rnn-structure3"></p>
...
<p><img src="@source/blogs/deep-learning/recurrent-neural-network/recurrent-neural-network/pic/rnn-vanishing-gradient.png" alt="rnn-vanishing-gradient"></p>
