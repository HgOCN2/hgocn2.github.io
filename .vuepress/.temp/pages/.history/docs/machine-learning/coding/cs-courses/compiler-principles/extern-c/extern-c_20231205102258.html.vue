...
<ul>
<li><RouterLink to="/.history/docs/machine-learning/coding/cs-courses/compiler-principles/compiler-principles.html">返回上层目录</RouterLink></li>
...
<p>2、如果C++语言使用了自己的LIB库（如输入输出<code v-pre>&lt;iostream&gt;</code>），则gcc无法链接，必须要加<code v-pre>-lstdc++</code>才行，而g++可以链接C++的LIB库。</p>
