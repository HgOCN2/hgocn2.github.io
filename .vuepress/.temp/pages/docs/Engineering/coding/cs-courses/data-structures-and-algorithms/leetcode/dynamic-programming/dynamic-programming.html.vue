...
<ul>
<li><RouterLink to="/docs/Engineering/coding/cs-courses/data-structures-and-algorithms/leetcode/leetcode.html">返回上层目录</RouterLink></li>
</ul>
...
$$
这产生了一个直观的动态规划解法，我们首先初始化一字母和二字母的回文，然后找到所有三字母回文，并依此类推…</p>
<p>复杂度分析</p>
<p>时间复杂度：$O(n^2)$，这里给出我们的运行时间复杂度为$O(n^2)$。</p>
<p>空间复杂度：$O(n^2)$，该方法使用$O(n^2)$的空间来存储表。</p>
<p>你能进一步优化上述解法的空间复杂度吗？</p>
<p>中心扩展算法
事实上，只需使用恒定的空间，我们就可以在$O(n^2)$的时间内解决这个问题。</p>
...
<p><img src="@source/docs/Engineering/coding/cs-courses/data-structures-and-algorithms/leetcode/dynamic-programming/pic/leetcode-62.png" alt="leetcode-62"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>假设$n$个节点存在二叉排序树的个数是$G(n)$，令$f(i)$为以$i$为根的二叉搜索树的个数，则
$$
