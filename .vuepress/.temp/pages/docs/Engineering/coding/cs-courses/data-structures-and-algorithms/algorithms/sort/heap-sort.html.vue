...
<p><img src="@source/docs/Engineering/coding/cs-courses/data-structures-and-algorithms/algorithms/sort/pic/heap-sort-1.jpg" alt="heap-sort-1"></p>
...
<p><img src="@source/docs/Engineering/coding/cs-courses/data-structures-and-algorithms/algorithms/sort/pic/heap-sort-2.jpg" alt="heap-sort-2"></p>
...
<p><img src="@source/docs/Engineering/coding/cs-courses/data-structures-and-algorithms/algorithms/sort/pic/heap-sort-3.jpg" alt="heap-sort-3"></p>
<p>5：如果某个节点和它的某个子节点交换后，该子节点又有子节点，系统还需要再次对该子节点进行判断。如上图因为1处、3处、4处中，1处的值大于3、4处的值，所以还需交换。</p>
<p><img src="@source/docs/Engineering/coding/cs-courses/data-structures-and-algorithms/algorithms/sort/pic/heap-sort-4.jpg" alt="heap-sort-4"></p>
