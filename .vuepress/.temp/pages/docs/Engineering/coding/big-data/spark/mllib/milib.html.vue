...
<li><RouterLink to="/docs/Engineering/coding/big-data/spark/mllib/lr.html">LR逻辑回归</RouterLink></li>
...
返回值$r$是我们说要的$p_k$。</p>
<p><img src="@source/docs/Engineering/coding/big-data/spark/mllib/pic/BFGSMultiply.png" alt="BFGSMultiply"></p>
...
<p><img src="@source/docs/Engineering/coding/big-data/spark/mllib/pic/spark-L-BFGS.png" alt="spark_L-BFGS"></p>
<p>迭代过程：
...
<p><img src="@source/docs/Engineering/coding/big-data/spark/mllib/pic/Spark-on-Angel.png" alt="Spark-on-Angel"></p>
<p>迭代过程：</p>
