...
<p><img src="@source/docs/Engineering/reinforcement-learning/reinforcement-learning/model-based-reinforcement-learning/pic/learning-map.png" alt="learning-map"></p>
...
<p><img src="@source/docs/Engineering/reinforcement-learning/reinforcement-learning/model-based-reinforcement-learning/pic/model-based-reinforcement-learning.png" alt="model-based-reinforcement-learning"></p>
...
<p><img src="@source/docs/Engineering/reinforcement-learning/reinforcement-learning/model-based-reinforcement-learning/pic/table-model-example.png" alt="table-model-example"></p>
...
<p><img src="@source/docs/Engineering/reinforcement-learning/reinforcement-learning/model-based-reinforcement-learning/pic/Dyna-structure.png" alt="Dyna-structure"></p>
...
<p>Dyna的Q学习算法：</p>
<p><img src="@source/docs/Engineering/reinforcement-learning/reinforcement-learning/model-based-reinforcement-learning/pic/Dyna-q-algorithm.png" alt="Dyna-q-algorithm"></p>
...
<p><img src="@source/docs/Engineering/reinforcement-learning/reinforcement-learning/model-based-reinforcement-learning/pic/Imagination-Augmented-Agents-for-Deep-Reinforcement-Learning.png" alt="Imagination-Augmented-Agents-for-Deep-Reinforcement-Learning"></p>
...
<p><img src="@source/docs/Engineering/reinforcement-learning/reinforcement-learning/model-based-reinforcement-learning/pic/forward-search.png" alt="forward-search"></p>
<ul>
...
<p><img src="@source/docs/Engineering/reinforcement-learning/reinforcement-learning/model-based-reinforcement-learning/pic/simulation-based-search.png" alt="simulation-based-search"></p>
<ul>
<li>
...
<p><img src="@source/docs/Engineering/reinforcement-learning/reinforcement-learning/model-based-reinforcement-learning/pic/Go-MCTS.png" alt="Go-MCTS"></p>
...
<p><img src="@source/docs/Engineering/reinforcement-learning/reinforcement-learning/model-based-reinforcement-learning/PIC/MCTS-1.png" alt="MCTS-1"></p>
<p>蒙特卡洛树搜索在每一步判断的时候，不只搜一次，继续搜。把下一个动作加到叶子节点中去，这一次值为0，所以分母加了1，分子没有加。</p>
<p><img src="@source/docs/Engineering/reinforcement-learning/reinforcement-learning/model-based-reinforcement-learning/PIC/MCTS-2.png" alt="MCTS-2"></p>
<p>由于刚才的动作不好，那换一个动作，按照UCB的分去搜。此次是个好的结果，那分子分母各加1。</p>
<p><img src="@source/docs/Engineering/reinforcement-learning/reinforcement-learning/model-based-reinforcement-learning/PIC/MCTS-3.png" alt="MCTS-3"></p>
<p>继续把下一个叶子节点加入。发现不行。</p>
<p><img src="@source/docs/Engineering/reinforcement-learning/reinforcement-learning/model-based-reinforcement-learning/PIC/MCTS-4.png" alt="MCTS-4"></p>
<p>那么继续换一个动作</p>
<p><img src="@source/docs/Engineering/reinforcement-learning/reinforcement-learning/model-based-reinforcement-learning/PIC/MCTS-5.png" alt="MCTS-5"></p>
...
<p><img src="@source/docs/Engineering/reinforcement-learning/reinforcement-learning/model-based-reinforcement-learning/pic/MCTS.png" alt="MCTS"></p>
<ul>
