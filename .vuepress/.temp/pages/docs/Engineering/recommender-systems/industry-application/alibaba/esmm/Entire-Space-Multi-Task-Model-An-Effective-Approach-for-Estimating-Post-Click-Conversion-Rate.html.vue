...
<p><img src="@source/docs/Engineering/recommender-systems/industry-application/alibaba/esmm/pic/paper.png" alt="paper"></p>
...
<p><img src="@source/docs/Engineering/recommender-systems/industry-application/alibaba/esmm/pic/esmm-model-structure.png" alt="esmm-model-structure"></p>
...
<p><img src="@source/docs/Engineering/recommender-systems/industry-application/alibaba/esmm/pic/experimental-datasets.png" alt="experimental-datasets"></p>
...
<p><img src="@source/docs/Engineering/recommender-systems/industry-application/alibaba/esmm/pic/comparison-of-different-models-on-public-dataset.png" alt="comparison-of-different-models-on-public-dataset"></p>
<p>其中，AUC以%为单位。</p>
<p>在Product数据集上，各模型在不同抽样率上的AUC曲线如下图所示，ESMM显示的稳定的优越性，曲线走势也说明了Data Sparsity的影响还是挺大的。</p>
<p><img src="@source/docs/Engineering/recommender-systems/industry-application/alibaba/esmm/pic/comparison-of-different-models-and-different-sampling-rates-on-product-dataset.png" alt="comparison-of-different-models-and-different-sampling-rates-on-product-dataset"></p>
