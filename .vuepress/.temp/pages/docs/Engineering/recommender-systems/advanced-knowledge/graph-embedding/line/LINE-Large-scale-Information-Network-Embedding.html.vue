...
<ul>
<li><RouterLink to="/docs/Engineering/recommender-systems/advanced-knowledge/graph-embedding/graph-embedding.html">返回上层目录</RouterLink></li>
...
<p><img src="@source/docs/Engineering/recommender-systems/advanced-knowledge/graph-embedding/line/pic/paper.png" alt="paper"></p>
...
<p><img src="@source/docs/Engineering/recommender-systems/advanced-knowledge/graph-embedding/line/pic/information-network.png" alt="information-network"></p>
...
<p>一个Naive的想法如下：</p>
<p><img src="@source/docs/Engineering/recommender-systems/advanced-knowledge/graph-embedding/line/pic/alias-1.png" alt="alias-1"></p>
<ol>
<li>可以像上图这样采样，将四个事件排成4列：1~4，扔两次骰子，第一次扔1~4之间的整数，决定落在哪一列。</li>
</ol>
<p><img src="@source/docs/Engineering/recommender-systems/advanced-knowledge/graph-embedding/line/pic/alias-2.png" alt="alias-2"></p>
<ol start="2">
...
<p><img src="@source/docs/Engineering/recommender-systems/advanced-knowledge/graph-embedding/line/pic/alias-3.png" alt="alias-3"></p>
<p>还是如上面的那样的思路，但是如果我们不按照其中最大的值去归一化，而是按照其均值归一化。即按照1/N（这里是1/4）归一化，即为所有概率乘以N，得到如下图：</p>
<p><img src="@source/docs/Engineering/recommender-systems/advanced-knowledge/graph-embedding/line/pic/alias-4.png" alt="alias-4"></p>
<p>其总面积为N，然后可以将其分成一个1*N的长方形，如下图：</p>
<p><img src="@source/docs/Engineering/recommender-systems/advanced-knowledge/graph-embedding/line/pic/alias-5.png" alt="alias-5"></p>
<p>将前两个多出来的部分补到后面两个缺失的部分中。
先将1中的部分补充到4中：</p>
<p><img src="@source/docs/Engineering/recommender-systems/advanced-knowledge/graph-embedding/line/pic/alias-6.png" alt="alias-6"></p>
<p>这时如果，将1,2中多出来的部分，补充到3中，就麻烦了，因为又陷入到如果从中采样超过2个以上的事件这个问题中，所以Alias Method一定要保证：<strong>每列中最多只放两个事件</strong>
所以此时需要讲1中的补满3中去：</p>
<p><img src="@source/docs/Engineering/recommender-systems/advanced-knowledge/graph-embedding/line/pic/alias-7.png" alt="alias-7"></p>
<p>再将2中的补到1中：</p>
<p><img src="@source/docs/Engineering/recommender-systems/advanced-knowledge/graph-embedding/line/pic/alias-8.png" alt="alias-8"></p>
<p>至此整个方法大功告成
...
<p><img src="@source/docs/Engineering/recommender-systems/advanced-knowledge/graph-embedding/line/pic/line_distribute_structure.png" alt="line_distribute_structure"></p>
