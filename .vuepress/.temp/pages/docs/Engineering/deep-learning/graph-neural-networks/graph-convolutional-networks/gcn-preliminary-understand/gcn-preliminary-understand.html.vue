...
<p><img src="@source/docs/Engineering/deep-learning/graph-neural-networks/graph-convolutional-networks/gcn-preliminary-understand/pic/gcn-paper.png" alt="gcn-paper"></p>
...
<p><img src="@source/docs/Engineering/deep-learning/graph-neural-networks/graph-convolutional-networks/gcn-preliminary-understand/pic/gcn-paper-1.png" alt="gcn-paper-1"></p>
...
<p>我们看论文原文：</p>
<p><img src="@source/docs/Engineering/deep-learning/graph-neural-networks/graph-convolutional-networks/gcn-preliminary-understand/pic/gcn-paper-2.png" alt="gcn-paper-2"></p>
<p>然后作者做了一个实验，使用一个俱乐部会员的关系网络，使用随机初始化的GCN进行特征提取，得到各个node的embedding，然后可视化：</p>
<p><img src="@source/docs/Engineering/deep-learning/graph-neural-networks/graph-convolutional-networks/gcn-preliminary-understand/pic/gcn-paper-3.png" alt="gcn-paper-3"></p>
...
<p><img src="@source/docs/Engineering/deep-learning/graph-neural-networks/graph-convolutional-networks/gcn-preliminary-understand/pic/gcn-paper-4.gif" alt="gcn-paper-4"></p>
