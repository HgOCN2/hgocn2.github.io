<template><div><h1 id="通用人工智能" tabindex="-1"><a class="header-anchor" href="#通用人工智能" aria-hidden="true">#</a> 通用人工智能</h1>
<ul>
<li><RouterLink to="/docs/Engineering/">返回上层目录</RouterLink></li>
<li><RouterLink to="/docs/Engineering/artificial-general-intelligence/industry-application/industry-application.html">业界应用</RouterLink></li>
</ul>
<p>===</p>
<p><a href="https://mp.weixin.qq.com/s/dHes97t7pIOrOWYz8shJIQ" target="_blank" rel="noopener noreferrer">Geoffrey Hinton 最新访谈：不出五年，我们就会破解大脑的运作机制，但不是通过反向传播<ExternalLinkIcon/></a></p>
