...
<p><img src="@source/docs/Engineering/machine-learning/perceptron/pic/perceptron-model.png" alt="perceptron-model"></p>
...
\end{aligned}
$$
<img src="@source/docs/Engineering/machine-learning/perceptron/pic/perceptron-example1.png" alt="perceptron-example1"></p>
<p>解：构建最优化问题
$$
\mathop{\text{min}}<em>{w,b}\ L(w,b)=-\sum</em>{x_i\in M}y_i(w\cdot x_i+b)
$$
...
$$
求解的整个迭代过程见下表</p>
<p><img src="@source/docs/Engineering/machine-learning/perceptron/pic/perceptron-example1-table.png" alt="perceptron-example1-table"></p>
...
$$
（4）迭代。过程从略，结果列于下表：</p>
<p><img src="@source/docs/Engineering/machine-learning/perceptron/pic/perceptron-example2-table.png" alt="perceptron-example2-table"></p>
<p>（5）</p>
<p>分离超平面：
$$
\begin{aligned}
...
<p><img src="@source/docs/Engineering/machine-learning/perceptron/pic/perceptron_matlab.png" alt="perceptron_matlab"></p>
<ul>
<li>对偶形式的matlab代码</li>
</ul>
