...
<ul>
<li><RouterLink to="/docs/deep-learning/tips/normalization/normalization.html">返回上层目录</RouterLink></li>
...
<p><img src="@source/docs/deep-learning/tips/normalization/batch-normalization/pic/paper.png" alt="paper"></p>
...
<p>多说不如一张图：</p>
<p><img src="@source/docs/deep-learning/tips/normalization/batch-normalization/pic/activation.jpeg" alt="activation"></p>
...
<p>先看论文里的截图：</p>
<p><img src="@source/docs/deep-learning/tips/normalization/batch-normalization/pic/batch-normalizing-transform.png" alt="batch-normalizing-transform"></p>
