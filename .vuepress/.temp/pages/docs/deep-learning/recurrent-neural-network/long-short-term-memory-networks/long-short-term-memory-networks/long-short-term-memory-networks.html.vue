...
<p><img src="@source/docs/deep-learning/recurrent-neural-network/long-short-term-memory-networks/long-short-term-memory-networks/pic/paper.png" alt="paper"></p>
...
<p><img src="@source/docs/deep-learning/recurrent-neural-network/long-short-term-memory-networks/long-short-term-memory-networks/pic/multiple-layer-LSTM.jpg" alt="multiple-layer-LSTM"></p>
<p>LSTM的结构是怎么发现的？</p>
<blockquote>
...
<p><img src="@source/docs/deep-learning/recurrent-neural-network/long-short-term-memory-networks/long-short-term-memory-networks/pic/LSTM.jpg" alt="LSTM"></p>
...
<p><img src="@source/docs/deep-learning/recurrent-neural-network/long-short-term-memory-networks/long-short-term-memory-networks/pic/LSTM-2.jpg" alt="LSTM-2"></p>
...
<p><img src="@source/docs/deep-learning/recurrent-neural-network/long-short-term-memory-networks/long-short-term-memory-networks/pic/cell.jpg" alt="cell"></p>
<p>我们来依次输入x序列，看整个流程是怎么运行的。为了简单起见，假设输入门和输出门的激活函数都是线性的，memory的初始值为0，具体如下图所示。</p>
<p><img src="@source/docs/deep-learning/recurrent-neural-network/long-short-term-memory-networks/long-short-term-memory-networks/pic/cell-1.jpg" alt="cell-1"></p>
<p>现在输入x的第一个向量[3, 1, 0]，计算流程如下图所示，具体就不细讲了，图里面的流程非常清楚，memory中的值会从0变为3+1x0=3，最后的输出是0。</p>
<p><img src="@source/docs/deep-learning/recurrent-neural-network/long-short-term-memory-networks/long-short-term-memory-networks/pic/cell-3.jpg" alt="cell-3"></p>
<p>接下来，输入x的第二个向量[4, 1, 0]，计算流程如下图所示，memory中的值会从0变为4+1x3=7，由于输出门关闭，最后的输出是0。</p>
<p><img src="@source/docs/deep-learning/recurrent-neural-network/long-short-term-memory-networks/long-short-term-memory-networks/pic/cell-4.jpg" alt="cell-4"></p>
<p>接下来，输入x的第三个向量[2, 0, 0]，计算流程如下图所示，memory中的值会从7变为0+1x7=7，由于输出门关闭，最后的输出是0。</p>
<p><img src="@source/docs/deep-learning/recurrent-neural-network/long-short-term-memory-networks/long-short-term-memory-networks/pic/cell-5.jpg" alt="cell-5"></p>
<p>接下来，输入x的第四个向量[1, 0, 1]，计算流程如下图所示，memory中的值会从7变为0+1x7=7，最后的输出是7。</p>
<p><img src="@source/docs/deep-learning/recurrent-neural-network/long-short-term-memory-networks/long-short-term-memory-networks/pic/cell-6.jpg" alt="cell-6"></p>
<p>接下来，输入x的最后一个向量[3, -1, 0]，计算流程如下图所示，memory中的值会从7变为0+0x7=0，最后的输出是0。</p>
<p><img src="@source/docs/deep-learning/recurrent-neural-network/long-short-term-memory-networks/long-short-term-memory-networks/pic/cell-7.jpg" alt="cell-7"></p>
...
<p><img src="@source/docs/deep-learning/recurrent-neural-network/long-short-term-memory-networks/long-short-term-memory-networks/pic/neurons.jpg" alt="neurons"></p>
<p>然后输入x乘上不同的权值作为LSTM单元的四个输入（输入和三个门）。就好像一般的机器插一个电源线就能运行，但LSTM这个机器需要插四个电压不同的电源线才能跑。所以同样的neuron数目下，LSTM的参数是一般的四倍。</p>
<p><img src="@source/docs/deep-learning/recurrent-neural-network/long-short-term-memory-networks/long-short-term-memory-networks/pic/neurons-1.jpg" alt="neurons-1"></p>
...
<p><img src="@source/docs/deep-learning/recurrent-neural-network/long-short-term-memory-networks/long-short-term-memory-networks/pic/LSTM-RNN.jpg" alt="LSTM-RNN"></p>
...
<p><img src="@source/docs/deep-learning/recurrent-neural-network/long-short-term-memory-networks/long-short-term-memory-networks/pic/LSTM-RNN-1.jpg" alt="LSTM-RNN-1"></p>
<p>然后里面相加后的向量$c^t$就是时刻t的memory中的值，然后如此反复下去，就会形成循环，那不就是RNN了吗。</p>
<p><img src="@source/docs/deep-learning/recurrent-neural-network/long-short-term-memory-networks/long-short-term-memory-networks/pic/LSTM-RNN-2.jpg" alt="LSTM-RNN-2"></p>
...
<p><img src="@source/docs/deep-learning/recurrent-neural-network/long-short-term-memory-networks/long-short-term-memory-networks/pic/LSTM-RNN-3.jpg" alt="LSTM-RNN-3"></p>
<p>上图只是LSTM只有一层的情况，但通常LSTM不会只有一层，再叠加个五六层才是我们要的样子。</p>
<p><img src="@source/docs/deep-learning/recurrent-neural-network/long-short-term-memory-networks/long-short-term-memory-networks/pic/multiple-layer-LSTM.jpg" alt="multiple-layer-LSTM"></p>
<p>每一次看到这个东西的人，它的反应都是这个样子：</p>
<p><img src="@source/docs/deep-learning/recurrent-neural-network/long-short-term-memory-networks/long-short-term-memory-networks/pic/newton-surprise.jpg" alt="newton-surprise"></p>
...
<p><img src="@source/docs/deep-learning/recurrent-neural-network/long-short-term-memory-networks/long-short-term-memory-networks/pic/lstm-detail-process.jpg" alt="lstm-detail-process"></p>
<h2 id="lstm输入输出分析" tabindex="-1"><a class="header-anchor" href="#lstm输入输出分析" aria-hidden="true">#</a> LSTM输入输出分析</h2>
<p><img src="@source/docs/deep-learning/recurrent-neural-network/long-short-term-memory-networks/long-short-term-memory-networks/pic/lstm-input.png" alt="lstm-input"></p>
