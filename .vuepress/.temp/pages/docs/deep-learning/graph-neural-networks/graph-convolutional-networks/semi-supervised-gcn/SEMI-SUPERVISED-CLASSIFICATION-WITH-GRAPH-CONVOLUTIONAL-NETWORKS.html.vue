...
<p><img src="@source/docs/deep-learning/graph-neural-networks/graph-convolutional-networks/semi-supervised-gcn/pic/semi-gcn-paper-title.png" alt="semi-gcn-paper-title"></p>
<blockquote>
...
<p><img src="@source/docs/deep-learning/graph-neural-networks/graph-convolutional-networks/semi-supervised-gcn/pic/semi-gcn-paper-gcn.png" alt="semi-gcn-paper-gcn"></p>
...
<p><img src="@source/docs/deep-learning/graph-neural-networks/graph-convolutional-networks/semi-supervised-gcn/pic/semi-gcn-paper-accuracy.png" alt="semi-gcn-paper-accuracy"></p>
<p><strong>不同传播模型的对比</strong></p>
<p><img src="@source/docs/deep-learning/graph-neural-networks/graph-convolutional-networks/semi-supervised-gcn/pic/semi-gcn-paper-models.png" alt="semi-gcn-paper-models"></p>
<p><strong>计算时间</strong></p>
<p>1000W边就只能CPU计算了，一个epoch差不多要10s</p>
<p><img src="@source/docs/deep-learning/graph-neural-networks/graph-convolutional-networks/semi-supervised-gcn/pic/semi-gcn-paper-time.png" alt="semi-gcn-paper-time"></p>
<p>硬件：</p>
