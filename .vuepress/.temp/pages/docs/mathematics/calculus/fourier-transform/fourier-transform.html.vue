...
<p><img src="@source/docs/mathematics/calculus/fourier-transform/pic/vectorAB.jpg" alt="vectorAB"></p>
<p>而$cos(\theta)=\frac{A\cdot B}{|A||B|}$，对于多维向量，假设$A = [1, 3, 7, 9]^{T}$，$B = [-4, 9, 7, -3]^{T}$。我们把不同维度依次排开在$x$轴上，$y$轴是不同维度对应的向量坐标值，则$A$、$B$向量如下图所示：</p>
<p><img src="@source/docs/mathematics/calculus/fourier-transform/pic/vectorA.jpg" alt="vectorA">                 <img src="@source/docs/mathematics/calculus/fourier-transform/pic/vectorB.jpg" alt="vectorB"></p>
