...
<ul>
<li>
<p><RouterLink to="/docs/mathematics/statistics/bayesian-analysis/bayesian-analysis.html">返回上层目录</RouterLink></p>
</li>
<li>
...
P(A|B)=\frac{P(AB)}{P(B)}
$$</p>
<p><img src="@source/docs/mathematics/statistics/bayesian-analysis/probability-and-bayesian-prior/PIC/conditional_probability.jpg" alt="conditional_probability"></p>
...
<p>因为显然$\hat{\mu}\neq\mu$啊。</p>
<p><img src="@source/docs/mathematics/statistics/bayesian-analysis/probability-and-bayesian-prior/pic/variance-biased-estimation.png" alt="variance-biased-estimation"></p>
