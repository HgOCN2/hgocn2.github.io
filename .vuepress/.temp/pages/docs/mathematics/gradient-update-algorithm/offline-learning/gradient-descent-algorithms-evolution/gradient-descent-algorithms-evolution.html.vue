...
<p><img src="@source/docs/mathematics/gradient-update-algorithm/offline-learning/gradient-descent-algorithms-evolution/pic/optimization-on-loss-surface-contours.gif" alt="optimization-on-loss-surface-contours"></p>
<h1 id="各类梯度下降算法的演化" tabindex="-1"><a class="header-anchor" href="#各类梯度下降算法的演化" aria-hidden="true">#</a> 各类梯度下降算法的演化</h1>
<p><img src="@source/docs/mathematics/gradient-update-algorithm/offline-learning/gradient-descent-algorithms-evolution/pic/revolution-of-gradient-descent.jpeg" alt="revolution-of-gradient-descent"></p>
