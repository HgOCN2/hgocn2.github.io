...
<ul>
<li><RouterLink to="/docs/recommender-systems/advanced-knowledge/reinforcement-learning/drn/reinforcement-learning.html">返回上层目录</RouterLink></li>
...
<p><img src="@source/docs/recommender-systems/advanced-knowledge/reinforcement-learning/drn/pic/DRN-model-framework.png" alt="DRN-model-framework"></p>
...
<p><img src="@source/docs/recommender-systems/advanced-knowledge/reinforcement-learning/drn/pic/Q-Network.png" alt="Q-Network"></p>
...
<p><img src="@source/docs/recommender-systems/advanced-knowledge/reinforcement-learning/drn/pic/user-activeness-estimation.png" alt="user-activeness-estimation"></p>
<p>参数
$$
S_0,\ S_a,\ \lambda_0,\ T_0
$$
根据数据集中的实际用户模式来确定。S0被设置为0.5，表示用户的随机初始状态（即可能是活跃的，也可能是不活跃的）。我们可以观察用户每两个连续请求之间的时间间隔的直方图，如图6所示。</p>
<p><img src="@source/docs/recommender-systems/advanced-knowledge/reinforcement-learning/drn/pic/time-interval-between-two-consecutive-requests.png" alt="time-interval-between-two-consecutive-requests"></p>
...
<p><img src="@source/docs/recommender-systems/advanced-knowledge/reinforcement-learning/drn/pic/exploration-by-dueling-bandit-gradient-descent.png" alt="exploration-by-dueling-bandit-gradient-descent"></p>
...
<p><img src="@source/docs/recommender-systems/advanced-knowledge/reinforcement-learning/drn/pic/user-and-news-basic-illustration.png" alt="user-and-news-basic-illustration"></p>
...
<p><img src="@source/docs/recommender-systems/advanced-knowledge/reinforcement-learning/drn/pic/parameter-setting.png" alt="parameter-setting"></p>
...
<p><img src="@source/docs/recommender-systems/advanced-knowledge/reinforcement-learning/drn/pic/offline-recommendation-accuracy.png" alt="offline-recommendation-accuracy"></p>
...
<p><img src="@source/docs/recommender-systems/advanced-knowledge/reinforcement-learning/drn/pic/offline-cumulative-CTR-of-different-methods.png" alt="offline-cumulative-CTR-of-different-methods"></p>
...
<p><img src="@source/docs/recommender-systems/advanced-knowledge/reinforcement-learning/drn/pic/online-recommendation-accuracy.png" alt="online-recommendation-accuracy"></p>
...
<p><img src="@source/docs/recommender-systems/advanced-knowledge/reinforcement-learning/drn/pic/diversity-of-user-clicked-news-in-the-online-experiment.png" alt="diversity-of-user-clicked-news-in-the-online-experiment"></p>
