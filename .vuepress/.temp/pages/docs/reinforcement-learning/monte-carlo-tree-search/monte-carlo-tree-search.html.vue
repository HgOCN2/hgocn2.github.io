...
<p><img src="@source/docs/reinforcement-learning/monte-carlo-tree-search/pic/mcts-paper.jpg" alt="mcts-paper"></p>
...
<p><img src="@source/docs/reinforcement-learning/monte-carlo-tree-search/pic/mcts-go-demo.gif" alt="mcts-go-demo"></p>
<p>搜索路径如下：</p>
<p><img src="@source/docs/reinforcement-learning/monte-carlo-tree-search/pic/mcts-go-demo-2.jpg" alt="mcts-go-demo-2"></p>
...
<p><img src="@source/docs/reinforcement-learning/monte-carlo-tree-search/pic/game-tree.png" alt="game-tree"></p>
...
<p><img src="@source/docs/reinforcement-learning/monte-carlo-tree-search/pic/one-iteration-of-general-mcts-approach.jpg" alt="one-iteration-of-general-mcts-approach"></p>
<p>总算法流程如下：</p>
<p><img src="@source/docs/reinforcement-learning/monte-carlo-tree-search/pic/general-mcts-approach.jpg" alt="general-mcts-approach"></p>
...
<p><img src="@source/docs/reinforcement-learning/monte-carlo-tree-search/pic/selection-and-expand.jpg" alt="selection-and-expand"></p>
<p><strong>Selection</strong>：</p>
<p><img src="@source/docs/reinforcement-learning/monte-carlo-tree-search/pic/selection.jpg" alt="selection"></p>
...
<p><img src="@source/docs/reinforcement-learning/monte-carlo-tree-search/pic/selection-2.jpg" alt="selection-2"></p>
<p>这个公式就不解释了，看不懂的话先看多臂赌博机和UCB算法。</p>
<p><strong>Expansion</strong>：</p>
<p><img src="@source/docs/reinforcement-learning/monte-carlo-tree-search/pic/expansion.jpg" alt="expansion"></p>
...
<p><img src="@source/docs/reinforcement-learning/monte-carlo-tree-search/pic/expansion-2.jpg" alt="expansion-2"></p>
<h2 id="simulation模拟" tabindex="-1"><a class="header-anchor" href="#simulation模拟" aria-hidden="true">#</a> Simulation模拟</h2>
<p><img src="@source/docs/reinforcement-learning/monte-carlo-tree-search/pic/simulation.jpg" alt="simulation"></p>
<p>从前面<code v-pre>Expansion</code>选出来的那个未被经历过的子节点开始，进行随机对战模拟，一直到游戏结束，然后计算奖励，赢了为正，输了为负。这个奖励值就作为该节点本次的奖励，留着用于反向传播。</p>
<p><img src="@source/docs/reinforcement-learning/monte-carlo-tree-search/pic/simulation-2.jpg" alt="simulation-2"></p>
...
<p><img src="@source/docs/reinforcement-learning/monte-carlo-tree-search/pic/backpropagation.jpg" alt="backpropagation"></p>
<p>从前面<code v-pre>Expansion</code>选出来的那个未被经历过的子节点开始，一直上溯父节点，并对每次经历的节点更新其总访问次数和总奖励值。</p>
<p><img src="@source/docs/reinforcement-learning/monte-carlo-tree-search/pic/backpropagation-2.jpg" alt="backpropagation-2"></p>
...
<p><img src="@source/docs/reinforcement-learning/monte-carlo-tree-search/pic/ai-vs-human.jpg" alt="ai-vs-human"></p>
...
<p><img src="@source/docs/reinforcement-learning/monte-carlo-tree-search/pic/min-max-search.png" alt="min-max-search"></p>
...
<p>下图是一个更多层的例子：</p>
<p><img src="@source/docs/reinforcement-learning/monte-carlo-tree-search/pic/min-max-search-2.png" alt="min-max-search-2"></p>
