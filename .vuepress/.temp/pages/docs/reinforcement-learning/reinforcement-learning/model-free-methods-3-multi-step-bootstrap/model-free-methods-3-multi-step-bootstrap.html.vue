...
<p><img src="@source/docs/reinforcement-learning/reinforcement-learning/model-free-methods-3-multi-step-bootstrap/pic/learning-map.png" alt="learning-map"></p>
...
<p><img src="@source/docs/reinforcement-learning/reinforcement-learning/model-free-methods-3-multi-step-bootstrap/pic/multi-step-TD-backup.png" alt="multi-step-TD-backup"></p>
<p>上图中黑色圈圈表示Q(S,A)。</p>
...
<p><img src="@source/docs/reinforcement-learning/reinforcement-learning/model-free-methods-3-multi-step-bootstrap/pic/n-step-TD.png" alt="n-step-TD"></p>
...
<p><img src="@source/docs/reinforcement-learning/reinforcement-learning/model-free-methods-3-multi-step-bootstrap/pic/n-step-TD-strategy-evaluation.png" alt="n-step-TD-strategy-evaluation"></p>
<p>两个注意的点：</p>
<ul>
...
<p><img src="@source/docs/reinforcement-learning/reinforcement-learning/model-free-methods-3-multi-step-bootstrap/pic/mix-2-step-and-4-step-reward.png" alt="mix-2-step-and-4-step-reward"></p>
...
<p>TD(λ)的备份图如下图：</p>
<p><img src="@source/docs/reinforcement-learning/reinforcement-learning/model-free-methods-3-multi-step-bootstrap/pic/TD-lambda-backup.png" alt="TD-lambda-backup"></p>
<ul>
<li>
...
<p><img src="@source/docs/reinforcement-learning/reinforcement-learning/model-free-methods-3-multi-step-bootstrap/pic/TD-lambda-weighted-function.png" alt="TD-lambda-weighted-function">
$$
...
<p><img src="@source/docs/reinforcement-learning/reinforcement-learning/model-free-methods-3-multi-step-bootstrap/pic/TD-lambda-forward-view.png" alt="TD-lambda-forward-view"></p>
<ul>
<li>
<p>通过使用λ回报值来更新值函数</p>
</li>
...
<p><img src="@source/docs/reinforcement-learning/reinforcement-learning/model-free-methods-3-multi-step-bootstrap/pic/eligibility-traces-example.png" alt="eligibility-traces-example"></p>
<ul>
<li>
...
<p><img src="@source/docs/reinforcement-learning/reinforcement-learning/model-free-methods-3-multi-step-bootstrap/pic/sumed-eligibility-traces.png" alt="sumed-eligibility-traces"></p>
...
$
一次会更新完所有的状态。</p>
<p><img src="@source/docs/reinforcement-learning/reinforcement-learning/model-free-methods-3-multi-step-bootstrap/pic/eligibility-traces-and-TD-error.png" alt="eligibility-traces-and-TD-error"></p>
</li>
<li>
...
<p><img src="@source/docs/reinforcement-learning/reinforcement-learning/model-free-methods-3-multi-step-bootstrap/pic/forward-backward-view-relationship-summary.png" alt="forward-backward-view-relationship-summary"></p>
...
<p>SARSA(λ)的备份图如下图：</p>
<p><img src="@source/docs/reinforcement-learning/reinforcement-learning/model-free-methods-3-multi-step-bootstrap/pic/SARSA-lambda-backup.png" alt="SARSA-lambda-backup"></p>
<ul>
<li>
...
<p><img src="@source/docs/reinforcement-learning/reinforcement-learning/model-free-methods-3-multi-step-bootstrap/pic/SARSA(lambda)-algorithm.png" alt="SARSA(lambda)-algorithm"></p>
