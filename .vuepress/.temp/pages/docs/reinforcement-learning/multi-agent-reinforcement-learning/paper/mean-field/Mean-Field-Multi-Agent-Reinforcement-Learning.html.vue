...
<ul>
<li><RouterLink to="/docs/reinforcement-learning/multi-agent-reinforcement-learning/paper/paper.html">返回上层目录</RouterLink></li>
</ul>
...
<p><img src="@source/docs/reinforcement-learning/multi-agent-reinforcement-learning/paper/mean-field/pic/mean-field-env-render.gif" alt="mean-field-env-render"></p>
