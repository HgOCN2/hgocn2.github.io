...
<p><img src="@source/docs/natural-language-processing/word2vec/word2vec-algorithm-principle/pic/Huffman-tree-construction-process.png" alt="Huffman-tree-construction process"></p>
...
<p><img src="@source/docs/natural-language-processing/word2vec/word2vec-algorithm-principle/pic/Huffman-code-example.png" alt="Huffman-code-example"></p>
