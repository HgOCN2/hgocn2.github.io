...
<p>移动示意图：</p>
<p><img src="@source/docs/coding/cs-courses/data-structures-and-algorithms/jianzhi-offer/string/pic/string-5.jpg" alt="string-5"></p>
<p>c++:</p>
...
<p><img src="@source/docs/coding/cs-courses/data-structures-and-algorithms/jianzhi-offer/string/pic/string-38.jpg" alt="string-38"></p>
<p>上图就是分别把第一个字符a和后面的b、c等字符交换的情形。首先固定第一个字符，求后面所有字符的排列。这个时候我们仍把后面的所有字符分为两部分：后面的字符的第一个字符，以及这个字符之后的所有字符。然后把第一个字符逐一和它后面的字符交换。</p>
<p>这个思路，是典型的递归思路：</p>
<p><img src="@source/docs/coding/cs-courses/data-structures-and-algorithms/jianzhi-offer/string/pic/string-38-2.png" alt="string-38-2"></p>
<p>c++:</p>
<div class="language-c++ line-numbers-mode" data-ext="c++"><pre v-pre class="language-c++"><code>class Solution {
public:
...
<p>用一张图表示如下：</p>
<p><img src="@source/docs/coding/cs-courses/data-structures-and-algorithms/jianzhi-offer/string/pic/string-19.png" alt="string-19"></p>
