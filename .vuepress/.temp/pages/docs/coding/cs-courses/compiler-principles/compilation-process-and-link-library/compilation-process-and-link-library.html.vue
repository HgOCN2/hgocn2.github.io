...
<p><img src="@source/docs/coding/cs-courses/compiler-principles/compilation-process-and-link-library/pic/compilation-process.png" alt="compilation-process"></p>
<ul>
<li>
