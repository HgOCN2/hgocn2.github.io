...
<p><img src="@source/docs/coding/big-data/spark/rdd/pic/rdd-reduce.gif" alt="rdd-reduce"></p>
...
<p><img src="@source/docs/coding/big-data/spark/rdd/pic/aggregate.jpg" alt="aggregate"></p>
<p>但需要注意：aggregate是在每个分区计算完成后，把所有的数据拉倒driver端，进行统一的遍历合并，这样如果数据量很大，在driver端可能会爆内存：OOM，这时候就需要使用treeAggregate了。</p>
<p>aggregate执行结构图:</p>
<p><img src="@source/docs/coding/big-data/spark/rdd/pic/aggregate2.jpeg" alt="aggregate2"></p>
...
<p><img src="@source/docs/coding/big-data/spark/rdd/pic/treeAggregate.jpg" alt="treeAggregate"></p>
<p>源码：</p>
...
<p><img src="@source/docs/coding/big-data/spark/rdd/pic/treeAggregate2.jpeg" alt="treeAggregate2"></p>
...
<p>错误的，不使用广播变量</p>
<p><img src="@source/docs/coding/big-data/spark/rdd/pic/not-use-broadcast.png" alt="not-use-broadcast"></p>
<p>正确的，使用广播变量的情况</p>
<p><img src="@source/docs/coding/big-data/spark/rdd/pic/use-broadcast.png" alt="use-broadcast"></p>
...
<p>错误的图解</p>
<p><img src="@source/docs/coding/big-data/spark/rdd/pic/wrong-accumulator.png" alt="wrong-accumulator"></p>
<p>正确的图解</p>
<p><img src="@source/docs/coding/big-data/spark/rdd/pic/right-accumulator.png" alt="right-accumulator"></p>
