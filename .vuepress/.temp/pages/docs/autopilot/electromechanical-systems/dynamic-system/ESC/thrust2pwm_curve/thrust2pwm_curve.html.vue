...
<ul>
<li><RouterLink to="/docs/autopilot/electromechanical-systems/dynamic-system/ESC/ESC.html">返回上层目录</RouterLink></li>
</ul>
...
<p><img src="@source/docs/autopilot/electromechanical-systems/dynamic-system/ESC/thrust2pwm_curve/pic/pwm2thrust_curve.png" alt="pwm2thrust_curve"></p>
...
$$
即</p>
<p><img src="@source/docs/autopilot/electromechanical-systems/dynamic-system/ESC/thrust2pwm_curve/pic/thrust2pwm_curve.png" alt="thrust2pwm_curve"></p>
<p>上图的python代码如下：</p>
