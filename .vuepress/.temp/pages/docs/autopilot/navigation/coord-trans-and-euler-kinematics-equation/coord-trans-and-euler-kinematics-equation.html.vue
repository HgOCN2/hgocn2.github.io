...
<p><img src="@source/docs/autopilot/navigation/coord-trans-and-euler-kinematics-equation/pic/ypr.jpg" alt="ypr"></p>
<h2 id="矢量旋转与坐标变换的关系" tabindex="-1"><a class="header-anchor" href="#矢量旋转与坐标变换的关系" aria-hidden="true">#</a> 矢量旋转与坐标变换的关系</h2>
<p>矢量旋转和坐标变换是逆向关系。</p>
<p><img src="@source/docs/autopilot/navigation/coord-trans-and-euler-kinematics-equation/D:/2study/课程与学习/0人工智能与机器学习/人工智能与机器学习/02书籍/书籍_数据/书籍/《机器学习笔记》/machine-learning-notes/docs/autopilot/navigation/coord-trans-and-euler-kinematics-equation/pic/vector-rot.png" alt="vector-rot"></p>
...
<p><img src="@source/docs/autopilot/navigation/coord-trans-and-euler-kinematics-equation/pic/rot-z-geometry.png" alt="rot-z-geometry"></p>
...
<p><img src="@source/docs/autopilot/navigation/coord-trans-and-euler-kinematics-equation/pic/rot-z.png" alt="rot-z"></p>
...
<p><img src="@source/docs/autopilot/navigation/coord-trans-and-euler-kinematics-equation/pic/rot-y.png" alt="rot-y"></p>
...
<p><img src="@source/docs/autopilot/navigation/coord-trans-and-euler-kinematics-equation/pic/rot-x.png" alt="rot-x"></p>
...
<p><img src="@source/docs/autopilot/navigation/coord-trans-and-euler-kinematics-equation/pic/ypr-process.png" alt="ypr-process"></p>
<p>具体为：</p>
<ul>
...
<p><img src="@source/docs/autopilot/navigation/coord-trans-and-euler-kinematics-equation/pic/angle-rate-translation.png" alt="angle-rate-translation"></p>
