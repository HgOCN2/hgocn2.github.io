...
<ul>
<li>
<p><RouterLink to="/docs/engineering/mathematics/numerical-calculation-and-optimization/convex-optimization/convex-optimization.html">返回上层目录</RouterLink></p>
</li>
<li>
...
<p><img src="@source/docs/engineering/mathematics/numerical-calculation-and-optimization/convex-optimization/convex-set-and-convex-function/pic/convex-and-no-convex-set.png" alt="convex-and-no-convex-set"></p>
<p>上图中，</p>
<ul>
...
<p><img src="@source/docs/engineering/mathematics/numerical-calculation-and-optimization/convex-optimization/convex-set-and-convex-function/pic/convex-function.png" alt="convex-function"></p>
...
$$
下图描述了上述不等式。</p>
<p><img src="@source/docs/engineering/mathematics/numerical-calculation-and-optimization/convex-optimization/convex-set-and-convex-function/pic/convex-function-first-order-derivative.png" alt="convex-function-first-order-derivative"></p>
...
<p><img src="@source/docs/engineering/mathematics/numerical-calculation-and-optimization/convex-optimization/convex-set-and-convex-function/pic/conjugate-function.png" alt="conjugate-function"></p>
...
<p><img src="@source/docs/engineering/mathematics/numerical-calculation-and-optimization/convex-optimization/convex-set-and-convex-function/pic/conjugate-function-sup.png" alt="conjugate-function-sup"></p>
<p>话说上面的解释虽然很直观，但我想下面的理解方法也需要给出。</p>
<p>如下图所示：</p>
<p><img src="@source/docs/engineering/mathematics/numerical-calculation-and-optimization/convex-optimization/convex-set-and-convex-function/pic/conjugate-function-1.png" alt="conjugate-function-1"></p>
<p>注意，这个函数并不是凸函数。</p>
...
<p><img src="@source/docs/engineering/mathematics/numerical-calculation-and-optimization/convex-optimization/convex-set-and-convex-function/pic/conjugate-function-x2.png" alt="conjugate-function-x2"></p>
<p><img src="@source/docs/engineering/mathematics/numerical-calculation-and-optimization/convex-optimization/convex-set-and-convex-function/pic/conjugate-function-x2-sup.png" alt="conjugate-function-x2-sup"></p>
<p>这里附上图的matlab代码：</p>
