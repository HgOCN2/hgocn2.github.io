...
<p><img src="@source/docs/engineering/natural-language-processing/seq2seq-and-attention-mechanism/pic/paper.png" alt="paper"></p>
...
<p><img src="@source/docs/engineering/natural-language-processing/seq2seq-and-attention-mechanism/pic/RNN-structures.png" alt="RNN-structures"></p>
...
<p>（1）简单结构</p>
<p><img src="@source/docs/engineering/natural-language-processing/seq2seq-and-attention-mechanism/pic/Seq2Seq-strcture1.png" alt="Seq2Seq-strcture1"></p>
...
<p>（2）复杂结构</p>
<p><img src="@source/docs/engineering/natural-language-processing/seq2seq-and-attention-mechanism/pic/Seq2Seq-strcture2.png" alt="Seq2Seq-strcture2"></p>
...
<p><img src="@source/docs/engineering/natural-language-processing/seq2seq-and-attention-mechanism/pic/show-and-tell.png" alt="show-and-tell"></p>
...
<p><img src="@source/docs/engineering/natural-language-processing/seq2seq-and-attention-mechanism/pic/encoder-decoder.jpeg" alt="encoder-decoder"></p>
...
<p><img src="@source/docs/engineering/natural-language-processing/seq2seq-and-attention-mechanism/pic/deconder-encoder-structure-1.png" alt="deconder-encoder-structure-1"></p>
<p>如果将$C$当作Decoder的每一时刻输入，则是Seq2Seq模型的第二种模型：</p>
<p><img src="@source/docs/engineering/natural-language-processing/seq2seq-and-attention-mechanism/pic/deconder-encoder-structure-2.png" alt="deconder-encoder-structure-2"></p>
...
<p><img src="@source/docs/engineering/natural-language-processing/seq2seq-and-attention-mechanism/pic/attention.png" alt="attention"></p>
...
$$
整个翻译流程如下：</p>
<p><img src="@source/docs/engineering/natural-language-processing/seq2seq-and-attention-mechanism/pic/attention-2.png" alt="attention-2"></p>
<p>图中输入是<code v-pre>Cat chase mouse</code>，Encoder中隐层$h_1$、$h_2$、$h_3$可看作经过计算<code v-pre>Cat、chase、mouse</code>这些词的信息。</p>
<p><img src="@source/docs/engineering/natural-language-processing/seq2seq-and-attention-mechanism/pic/attention-3.png" alt="attention-3"></p>
...
<p><img src="@source/docs/engineering/natural-language-processing/seq2seq-and-attention-mechanism/pic/attention-4.png" alt="attention-4"></p>
<p>那么参数$a_{ij}$是如何得到呢？</p>
<p>Encoder中第$j$个隐层单元$h_j$和Decoder第$i-1$个隐层单元$h^{'}<em>{i-1}$经过运算得到$a</em>{ij}$。</p>
<p>例如$a_{1j}$的计算过程：</p>
<p><img src="@source/docs/engineering/natural-language-processing/seq2seq-and-attention-mechanism/pic/attention-5.png" alt="attention-5"></p>
<p>例如$a_{2j}$的计算过程：</p>
<p><img src="@source/docs/engineering/natural-language-processing/seq2seq-and-attention-mechanism/pic/attention-6.png" alt="attention-6"></p>
<p>那具体是怎么运算得到的呢？我们来把上面的过程用公式严谨的表达出来。我们按照原论文的标点符号来进行推导。</p>
<p><img src="@source/docs/engineering/natural-language-processing/seq2seq-and-attention-mechanism/pic/attention-7.png" alt="attention-7"></p>
...
<p><img src="@source/docs/engineering/natural-language-processing/seq2seq-and-attention-mechanism/pic/attention-8.png" alt="attention-8"></p>
