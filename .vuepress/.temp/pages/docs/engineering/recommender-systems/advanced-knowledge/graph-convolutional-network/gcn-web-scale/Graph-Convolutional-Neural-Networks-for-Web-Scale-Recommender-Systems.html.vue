...
<ul>
<li><RouterLink to="/docs/engineering/recommender-systems/advanced-knowledge/graph-convolutional-network/advanced-knowledge.html">返回上层目录</RouterLink></li>
...
<p><img src="@source/docs/engineering/recommender-systems/advanced-knowledge/graph-convolutional-network/gcn-web-scale/pic/gcn-ws-rs-paper-title.png" alt="gcn-ws-rs-paper-title"></p>
<blockquote>
...
<p><img src="@source/docs/engineering/recommender-systems/advanced-knowledge/graph-convolutional-network/gcn-web-scale/pic/Pinterest.png" alt="Pinterest"></p>
...
<p>下图是论文提出来的卷积模型结构</p>
<p><img src="@source/docs/engineering/recommender-systems/advanced-knowledge/graph-convolutional-network/gcn-web-scale/pic/gcn-ws-rs-paper-model.png" alt="gcn-ws-rs-paper-model"></p>
<p>整个算法中，局部卷积算法'CONVOLVE'应该是最核心的部分。</p>
<p><img src="@source/docs/engineering/recommender-systems/advanced-knowledge/graph-convolutional-network/gcn-web-scale/pic/gcn-ws-rs-paper-local-conv.png" alt="gcn-ws-rs-paper-local-conv"></p>
...
<p><img src="@source/docs/engineering/recommender-systems/advanced-knowledge/graph-convolutional-network/gcn-web-scale/pic/gcn-ws-rs-paper-local-conv-desc.png" alt="gcn-ws-rs-paper-local-conv-desc"></p>
<p>先是对节点的领域节点经过Q映射后，再利用weight-pooling函数γ让输出的维度和输入保持一致，生成所有领域节点统一的embedding向量$h_{N(A)}$。</p>
...
<p><img src="@source/docs/engineering/recommender-systems/advanced-knowledge/graph-convolutional-network/gcn-web-scale/pic/gcn-ws-rs-paper-model-tranning.png" alt="gcn-ws-rs-paper-model-tranning"></p>
...
<p>作者定义的损失函数是hinge loss:
$$
\mathcal{J}<em>{\mathcal{G}}(z_qz_i)=\mathbb{E}</em>{n_k\sim P_n(q)}\text{max}\left{0,z_qz_{\text{neg}_k}-z_q\cdot z_i+\Delta\right}
$$
文章后面还写了一些实际实现工程中的加速优化，这里就不说了。大家可以直接去看原文，或者这里看这哥们<a href="https://davidham3.github.io/blog/2018/06/17/graph-convolutional-neural-networks-for-web-scale-recommender-systems/" target="_blank" rel="noopener noreferrer">翻译的文章<ExternalLinkIcon/></a>。</p>
