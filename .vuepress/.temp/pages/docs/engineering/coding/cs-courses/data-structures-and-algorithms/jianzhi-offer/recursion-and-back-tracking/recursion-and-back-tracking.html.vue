...
<p>斐波那契数列公式为：</p>
<p><img src="@source/docs/engineering/coding/cs-courses/data-structures-and-algorithms/jianzhi-offer/recursion-and-back-tracking/pic/recursion-10.jpg" alt="recursion-10"></p>
</blockquote>
<p>这道题递归很好写，但是存在很严重的效率问题。我们以求解f(10)为例类分析递归的求解过程。想求f(10)，需要先求得f(9)和f(8)。同样，想求得f(9)，需要先求的f(8)和f(7)....我们可以用树形结构来表示这种依赖关系，如下图所示：</p>
<p><img src="@source/docs/engineering/coding/cs-courses/data-structures-and-algorithms/jianzhi-offer/recursion-and-back-tracking/pic/recursion-10-2.jpg" alt="recursion-10-2"></p>
...
<p>以2x8的矩形为例。示意图如下：</p>
<p><img src="@source/docs/engineering/coding/cs-courses/data-structures-and-algorithms/jianzhi-offer/recursion-and-back-tracking/pic/recursion-10-3.jpg" alt="recursion-10-3"></p>
...
<p><img src="@source/docs/engineering/coding/cs-courses/data-structures-and-algorithms/jianzhi-offer/recursion-and-back-tracking/pic/back-tracking_12.png" alt="back-tracking_12"></p>
</blockquote>
