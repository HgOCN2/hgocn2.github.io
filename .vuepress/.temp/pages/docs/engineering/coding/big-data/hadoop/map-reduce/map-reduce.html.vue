...
<ul>
<li><RouterLink to="/docs/engineering/coding/big-data/hadoop/map-reduce/hadoop.html">返回上层目录</RouterLink></li>
</ul>
...
<p><img src="@source/docs/engineering/coding/big-data/hadoop/map-reduce/pic/mapreduce-word-count-process.jpg" alt="mapreduce-word-count-process"></p>
