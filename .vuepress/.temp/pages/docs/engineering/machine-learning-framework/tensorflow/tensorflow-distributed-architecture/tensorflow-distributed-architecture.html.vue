...
<p>定义GPU集群的拓扑结构：</p>
<p><img src="@source/docs/engineering/machine-learning-framework/tensorflow/tensorflow-distributed-architecture/pic/gpu-cluster-topology.jpg" alt="gpu-cluster-topology"></p>
...
<p><img src="@source/docs/engineering/machine-learning-framework/tensorflow/tensorflow-distributed-architecture/pic/scatter-reduce-1.jpg" alt="scatter-reduce-1"></p>
<p>Step2：N-1轮的scatter-reduce，每一轮中，每个GPU将自己的一个chunk发给右邻居，并接收左邻居发来的chunk，并累加。</p>
<p><img src="@source/docs/engineering/machine-learning-framework/tensorflow/tensorflow-distributed-architecture/pic/scatter-reduce-2.jpg" alt="scatter-reduce-2"></p>
<p><img src="@source/docs/engineering/machine-learning-framework/tensorflow/tensorflow-distributed-architecture/pic/scatter-reduce-3.jpg" alt="scatter-reduce-3"></p>
<p><img src="@source/docs/engineering/machine-learning-framework/tensorflow/tensorflow-distributed-architecture/pic/scatter-reduce-4.jpg" alt="scatter-reduce-4"></p>
<p><img src="@source/docs/engineering/machine-learning-framework/tensorflow/tensorflow-distributed-architecture/pic/scatter-reduce-5.jpg" alt="scatter-reduce-5"></p>
<p><img src="@source/docs/engineering/machine-learning-framework/tensorflow/tensorflow-distributed-architecture/pic/scatter-reduce-6.jpg" alt="scatter-reduce-6"></p>
...
<p><img src="@source/docs/engineering/machine-learning-framework/tensorflow/tensorflow-distributed-architecture/pic/allgather-1.jpg" alt="allgather-1"></p>
<p><img src="@source/docs/engineering/machine-learning-framework/tensorflow/tensorflow-distributed-architecture/pic/allgather-2.jpg" alt="allgather-2"></p>
<p><img src="@source/docs/engineering/machine-learning-framework/tensorflow/tensorflow-distributed-architecture/pic/allgather-3.jpg" alt="allgather-3"></p>
<p><img src="@source/docs/engineering/machine-learning-framework/tensorflow/tensorflow-distributed-architecture/pic/allgather-4.jpg" alt="allgather-4"></p>
<p><img src="@source/docs/engineering/machine-learning-framework/tensorflow/tensorflow-distributed-architecture/pic/allgather-5.jpg" alt="allgather-5"></p>
<p>通信代价分析：</p>
<ul>
<li>
