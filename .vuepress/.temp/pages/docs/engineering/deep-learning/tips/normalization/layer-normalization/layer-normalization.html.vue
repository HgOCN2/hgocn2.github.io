...
<ul>
<li><RouterLink to="/docs/engineering/deep-learning/tips/normalization/tips.html">返回上层目录</RouterLink></li>
</ul>
...
<p>如下图所示：</p>
<p><img src="@source/docs/engineering/deep-learning/tips/normalization/layer-normalization/pic/bn_vs_ln.jpg" alt="bn_vs_ln"></p>
