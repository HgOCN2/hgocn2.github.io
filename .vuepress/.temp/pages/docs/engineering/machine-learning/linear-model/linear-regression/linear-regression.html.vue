...
<ul>
<li>
<p><RouterLink to="/docs/engineering/machine-learning/linear-model/linear-model.html">返回上层目录</RouterLink></p>
</li>
<li>
...
<p><img src="@source/docs/engineering/machine-learning/linear-model/linear-regression/pic/model-select.png" alt="model-select"></p>
...
<p>那么你的数据点在图上可以这么看：</p>
<p><img src="@source/docs/engineering/machine-learning/linear-model/linear-regression/pic/regression-house-price-prediction.png" alt="regression-house-price-prediction"></p>
...
<p><img src="@source/docs/engineering/machine-learning/linear-model/linear-regression/pic/regression-house-price-prediction-2.png" alt="regression-house-price-prediction-2"></p>
...
<p><img src="@source/docs/engineering/machine-learning/linear-model/linear-regression/pic/regression-house-price-prediction-3.png" alt="regression-house-price-prediction-3"></p>
...
<p><img src="@source/docs/engineering/machine-learning/linear-model/linear-regression/pic/regression-house-price-prediction-4.png" alt="regression-house-price-prediction-4"></p>
<p>只要将任意一个a，沿着使cost<strong>导数的反方向</strong>慢慢移动，那么最终有一天a值就会到达使cost最小的那一点。于是你可以不断地移动a、b向着最低点前进。</p>
<p><img src="@source/docs/engineering/machine-learning/linear-model/linear-regression/pic/regression-house-price-prediction-5.gif" alt="regression-house-price-prediction-5"></p>
<p><img src="@source/docs/engineering/machine-learning/linear-model/linear-regression/pic/regression-house-price-prediction-6.gif" alt="regression-house-price-prediction-6"></p>
...
<p><img src="@source/docs/engineering/machine-learning/linear-model/linear-regression/pic/regression-house-price-prediction-7.jpg" alt="regression-house-price-prediction-7"></p>
...
<p><img src="@source/docs/engineering/machine-learning/linear-model/linear-regression/pic/regression-house-price-prediction-8.jpg" alt="regression-house-price-prediction-8"></p>
<p>我们想要找到使cost function最小的θ，就是找到使得导数取0时的参数θ：
该参数可由图中红框公式获得：</p>
<p><img src="@source/docs/engineering/machine-learning/linear-model/linear-regression/pic/regression-house-price-prediction-9.jpg" alt="regression-house-price-prediction-9"></p>
<p>具体来说：X是m×(n+1)的矩阵，y是m×1的矩阵。</p>
<p><img src="@source/docs/engineering/machine-learning/linear-model/linear-regression/pic/regression-house-price-prediction-10.jpg" alt="regression-house-price-prediction-10"></p>
...
<p><img src="@source/docs/engineering/machine-learning/linear-model/linear-regression/pic/regression-house-price-prediction-12.jpg" alt="regression-house-price-prediction-12"></p>
...
<p><img src="@source/docs/engineering/machine-learning/linear-model/linear-regression/pic/regression-house-price-prediction-11.jpg" alt="regression-house-price-prediction-11"></p>
