...
<p><img src="@source/docs/machine-learning/linear-model/logistic-regression/pic/logistic-regression-loser-winner-predict.png" alt="logistic-regression-loser-winner-predict"></p>
...
<p>小范围看长这样(像是S型曲线)：</p>
<p><img src="@source/docs/machine-learning/linear-model/logistic-regression/pic/sigmoid-1.png" alt="sigmoid"></p>
<p>大范围看长这样(更加类似于阶跃函数)：</p>
<p><img src="@source/docs/machine-learning/linear-model/logistic-regression/pic/sigmoid-2.png" alt="sigmoid"></p>
...
<p><img src="@source/docs/machine-learning/linear-model/logistic-regression/pic/non-convex-function.jpg" alt="non-convex-function"></p>
...
$$
<img src="@source/docs/machine-learning/linear-model/logistic-regression/pic/softmax.jpg" alt="softmax"></p>
...
<p>先把这张概率图模型放上来：</p>
<p><img src="@source/docs/machine-learning/linear-model/logistic-regression/pic/PGM_ML.jpg" alt="PGM_ML"></p>
