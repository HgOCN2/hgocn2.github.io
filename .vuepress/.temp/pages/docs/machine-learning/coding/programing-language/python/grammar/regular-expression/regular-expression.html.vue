...
<ul>
<li><RouterLink to="/docs/machine-learning/coding/programing-language/python/grammar/regular-expression/python.html#python">返回上层目录</RouterLink></li>
...
<ul>
<li>
<p><code v-pre>^</code> 用于匹配一个字符串的开头</p>
</li>
<li>
<p><code v-pre>$</code> 用于匹配一个字符串的结尾</p>
...
<p>匹配分组</p>
<ul>
<li><code v-pre>|</code> 表示或，匹配|连接的任何一个表达式</li>
<li><code v-pre>()</code> 将括号中字符作为一个分组</li>
<li><code v-pre>\\NUM</code> 配合分组<code v-pre>()</code>使用，引用分组NUM（NUM表示分组的编号）对应的匹配规则</li>
<li><code v-pre>(?P&lt;name&gt;)</code> 给分组起别名</li>
<li><code v-pre>(?P=name)</code> 应用指定别名的分组匹配到的字符串</li>
</ul>
</li>
</ul>
<p>转义字符</p>
