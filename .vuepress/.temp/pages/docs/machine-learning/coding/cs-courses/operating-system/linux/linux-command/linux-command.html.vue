...
<p>3 查看文件的几行到几行</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">sed</span> <span class="token parameter variable">-n</span> <span class="token string">'10,10000p'</span> /var/lib/mysql/slowquery.log <span class="token operator">></span> temp.log
...
<p><img src="@source/docs/machine-learning/coding/cs-courses/operating-system/linux/linux-command/pic/df.jpg" alt="df"></p>
<p>显示内容参数说明：</p>
<ul>
