...
<li><RouterLink to="/docs/machine-learning/ensemble-learning/bagging/bagging.html">Bagging</RouterLink></li>
<li><RouterLink to="/docs/machine-learning/ensemble-learning/boosting/boosting.html">Boosting</RouterLink></li>
