...
<p>我们来实现下图所示的计算流程：</p>
<p><img src="@source/docs/machine-learning/machine-learning-framework/tensorflow/tensorflow1.0/basis/pic/basic-practice-model.png" alt="basic-practice-model"></p>
<p>导入TensorFlow库：</p>
...
<p><img src="@source/docs/machine-learning/machine-learning-framework/tensorflow/tensorflow1.0/basis/pic/basic-practice-tensor-board-graph.png" alt="basic-practice-tensor-board-graph"></p>
...
<p>本练习的模型为：</p>
<p><img src="@source/docs/machine-learning/machine-learning-framework/tensorflow/tensorflow1.0/basis/pic/combined-practice-model.png" alt="combined-practice-model"></p>
<p>本练习的数据流图为：</p>
<p><img src="@source/docs/machine-learning/machine-learning-framework/tensorflow/tensorflow1.0/basis/pic/combined-practice-dataflow.png" alt="combined-practice-dataflow"></p>
<p>下面开始动手实践：</p>
...
<p>数据流图总览：</p>
<p><img src="@source/docs/machine-learning/machine-learning-framework/tensorflow/tensorflow1.0/basis/pic/combined-practice-tensor-board-graph.png" alt="combined-practice-tensor-board-graph"></p>
<p>数据流图详细展示：</p>
<p><img src="@source/docs/machine-learning/machine-learning-framework/tensorflow/tensorflow1.0/basis/pic/combined-practice-tensor-board-graph-expand.png" alt="combined-practice-tensor-board-graph-expand"></p>
...
<p><img src="@source/docs/machine-learning/machine-learning-framework/tensorflow/tensorflow1.0/basis/pic/combined-practice-average-summary.png" alt="combined-practice-average-summary"><img src="@source/docs/machine-learning/machine-learning-framework/tensorflow/tensorflow1.0/basis/pic/combined-practice-output-summary.png" alt="combined-practice-output-summary"><img src="@source/docs/machine-learning/machine-learning-framework/tensorflow/tensorflow1.0/basis/pic/combined-practice-total-summary.png" alt="combined-practice-total-summary"></p>
