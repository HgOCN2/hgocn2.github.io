<template><div><h1 id="基于tenserflow的目标识别与分类" tabindex="-1"><a class="header-anchor" href="#基于tenserflow的目标识别与分类" aria-hidden="true">#</a> 基于TenserFlow的目标识别与分类</h1>
<ul>
...
<h1 id="简化版alexnet的实现" tabindex="-1"><a class="header-anchor" href="#简化版alexnet的实现" aria-hidden="true">#</a> 简化版AlexNet的实现</h1>
<p>我们的网络架构采取了AlexNet的简化版本，但并未使用AlexNet的所有层，也和TensorFlow提供的CNN入门教程非常类似。</p>
<h2 id="网络的架构" tabindex="-1"><a class="header-anchor" href="#网络的架构" aria-hidden="true">#</a> 网络的架构</h2>
<p><img src="@source/docs/machine-learning/machine-learning-framework/tensorflow/tensorflow1.0/cnn/pic/alexnet-architecture.png" alt="alexnet-architecture"></p>
<h2 id="stanford-dogs数据集" tabindex="-1"><a class="header-anchor" href="#stanford-dogs数据集" aria-hidden="true">#</a> Stanford Dogs数据集</h2>
<p><a href="http://vision.stanford.edu/aditya86/ImageNetDogs/" target="_blank" rel="noopener noreferrer">Stanford Dogs Dataset<ExternalLinkIcon/></a>，<a href="http://vision.stanford.edu/aditya86/ImageNetDogs/README.txt" target="_blank" rel="noopener noreferrer">ReadMe<ExternalLinkIcon/></a></p>
<p>该数据集的总大小大约800M，需要将下载的压缩文件解压至和程序文件同目录下的一个新的名为<code v-pre>imagenet-dogs</code>的目录下。</p>
<p>该数据集包含120个不同品种的狗的图像，其中80%的图像用于训练，而其余20%的图像用于测试。</p>
<p><img src="@source/docs/machine-learning/machine-learning-framework/tensorflow/tensorflow1.0/cnn/pic/stanford-dogs-dataset.png" alt="stanford-dogs-dataset"></p>
<p>每个狗品种都对应一个类似于<code v-pre>n02085620-Chihuahua</code>的文件夹，其中目录名称的后一半对应于狗品种的英语表达。在每个目录中，都有大量属于该品种的狗的图像，每幅图都是JPEG格式且尺寸各异。</p>
<p><img src="@source/docs/machine-learning/machine-learning-framework/tensorflow/tensorflow1.0/cnn/pic/stanford-dogs-dataset-chihuahua.png" alt="stanford-dogs-dataset-chihuahua"></p>
<h2 id="一步步写代码" tabindex="-1"><a class="header-anchor" href="#一步步写代码" aria-hidden="true">#</a> 一步步写代码</h2>
<h3 id="将图像转为tfrecord文件" tabindex="-1"><a class="header-anchor" href="#将图像转为tfrecord文件" aria-hidden="true">#</a> 将图像转为TFRecord文件</h3>
<p>（1）引入tf包</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>（2）读取目录下的每一个图片的路径和名称：</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> glob
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token punctuation">[</span><span class="token string">'./imagenet-dogs/n02097658-silky_terrier/n02097658_26.jpg'</span><span class="token punctuation">,</span>
 <span class="token string">'./imagenet-dogs/n02097658-silky_terrier/n02097658_4869.jpg'</span><span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>（3）将品种和各自品种的图像名称放到train和test字典中。</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">from</span> itertools <span class="token keyword">import</span> groupby
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>（4）打开每幅图像，将其专为灰度图，调整尺寸，然后添加到TFRecord文件中。</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">def</span> <span class="token function">write_records_file</span><span class="token punctuation">(</span>dataset<span class="token punctuation">,</span> record_location<span class="token punctuation">)</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="加载图像" tabindex="-1"><a class="header-anchor" href="#加载图像" aria-hidden="true">#</a> 加载图像</h3>
<p>一旦测试集和训练集被转换为TFRecord格式，便可以按照TFRecord文件而非JPEG文件进行读取。我们的目标是每次加载少量图像及相应的标签。</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token comment"># string_input_producer会产生一个文件名队列；match_filenames_once获取符合正则表达式的文件列表</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="模型" tabindex="-1"><a class="header-anchor" href="#模型" aria-hidden="true">#</a> 模型</h3>
<p>（1）第一个卷积层</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token comment"># 将图像转换为灰度值位于[0,1]的浮点类型，以与convolution2d期望的输入匹配</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>（3）展开最后一个池化层</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>flattened_layer_two <span class="token operator">=</span> tf<span class="token punctuation">.</span>reshape<span class="token punctuation">(</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>（4）两个全连接层</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token comment"># weight_init参数也可接收一个可用参数，这里使用一个lambda表达式返回了一个截断的正态分布</span>
...
<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="训练" tabindex="-1"><a class="header-anchor" href="#训练" aria-hidden="true">#</a> 训练</h3>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> glob
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>损失、优化器、学习率</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>loss <span class="token operator">=</span> tf<span class="token punctuation">.</span>reduce_mean<span class="token punctuation">(</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token comment"># setup-only-ignore</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="最终的代码" tabindex="-1"><a class="header-anchor" href="#最终的代码" aria-hidden="true">#</a> 最终的代码</h2>
<h1 id="参考资料" tabindex="-1"><a class="header-anchor" href="#参考资料" aria-hidden="true">#</a> 参考资料</h1>
<ul>
<li><a href="https://github.com/backstopmedia/tensorflowbook/blob/master/chapters/05_object_recognition_and_classification/Chapter%205%20-%2005%20CNN%20Implementation.ipynb" target="_blank" rel="noopener noreferrer">backstopmedia/tensorflowbook<ExternalLinkIcon/></a></li>
<li><a href="https://blog.csdn.net/hnxyxiaomeng/article/details/78517350" target="_blank" rel="noopener noreferrer">《面向机器智能的tensorflow实践》第5.5节Stanford Dogs例程实现<ExternalLinkIcon/></a></li>
<li><a href="https://github.com/Alex-AI-Du/Tensorflow-Tutorial/blob/master/standford_dog/ST_run.py" target="_blank" rel="noopener noreferrer">Alex-AI-Du/Tensorflow-Tutorial<ExternalLinkIcon/></a></li>
</ul>
<p>本文参考了这几篇资料。</p>
</div></template>
