...
<ul>
<li><RouterLink to="/docs/machine-learning/natural-language-processing/large-language-model/industry-application/blinkdl/blinkdl.html">返回上层目录</RouterLink></li>
</ul>
...
<p><img src="@source/docs/machine-learning/natural-language-processing/large-language-model/industry-application/blinkdl/ChatRWKV/pic/discord-rwkv.png" alt="discord-rwkv"></p>
