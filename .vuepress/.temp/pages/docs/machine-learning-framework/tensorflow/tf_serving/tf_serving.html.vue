...
<ul>
<li><RouterLink to="/docs/machine-learning-framework/tensorflow/tensorflow.html">返回上层目录</RouterLink></li>
...
<p><img src="@source/docs/machine-learning-framework/tensorflow/tf_serving/pic/web-framework.jpg" alt="web-framework"></p>
<p>TFserving + Flask的部署方式：</p>
<p><img src="@source/docs/machine-learning-framework/tensorflow/tf_serving/pic/flask-tfserving.jpg" alt="flask-tfserving"></p>
...
<p><img src="@source/docs/machine-learning-framework/tensorflow/tf_serving/pic/tfserving.jpg" alt="tfserving"></p>
...
<p><img src="@source/docs/machine-learning-framework/tensorflow/tf_serving/pic/docker-win10-download.jpg" alt="docker-win10-download"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/docs/machine-learning-framework/tensorflow/tf_serving/pic/docker-pull-tfserving.jpg" alt="docker-pull-tfserving"></p>
...
<p>输出：</p>
<p><img src="@source/docs/machine-learning-framework/tensorflow/tf_serving/pic/docker-ps.jpg" alt="docker-ps"></p>
...
<p><img src="@source/docs/machine-learning-framework/tensorflow/tf_serving/pic/flask-logo.png" alt="flask-logo"></p>
...
<p><img src="@source/docs/machine-learning-framework/tensorflow/tf_serving/pic/single-nginx-multi-gunicorn-flask.png" alt="single-nginx-multi-gunicorn-flask"></p>
...
<p><img src="@source/docs/machine-learning-framework/tensorflow/tf_serving/pic/nginx-gunicore-flask.jpg" alt="nginx-gunicore-flask"></p>
<p>首先来看两个概念</p>
...
<p><img src="@source/docs/machine-learning-framework/tensorflow/tf_serving/pic/why-need-nginx.jpg" alt="why-need-nginx"></p>
...
<p>示意图如下：</p>
<p><img src="@source/docs/machine-learning-framework/tensorflow/tf_serving/pic/reverse-proxy.png" alt="reverse-proxy"></p>
...
<p>负载均衡的示意图如下：</p>
<p><img src="@source/docs/machine-learning-framework/tensorflow/tf_serving/pic/load-balance.png" alt="load-balance"></p>
...
<p>在本地打开：</p>
<p><img src="@source/docs/machine-learning-framework/tensorflow/tf_serving/pic/nginx-localhost-http.jpg" alt="nginx-localhost-http"></p>
<p>在局域网其他主机打开（<code v-pre>192.168.43.75</code>是其在局域网中的IP）：</p>
<p><img src="@source/docs/machine-learning-framework/tensorflow/tf_serving/pic/nginx-other-ip-http.jpg" alt="nginx-other-ip-http"></p>
